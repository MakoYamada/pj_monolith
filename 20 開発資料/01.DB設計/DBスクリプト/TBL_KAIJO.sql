...
CREATE TABLE [dbo].[TBL_KAIJO](
	...
	[KAISAI_DATE_NOTE] [nvarchar](255) COLLATE Japanese_CI_AS  NULL,
	[KAISAI_KIBOU_ADDRESS1] [nvarchar](20) COLLATE Japanese_CI_AS  NULL,
	[KAISAI_KIBOU_ADDRESS2] [nvarchar](80) COLLATE Japanese_CI_AS  NULL,
	[KAISAI_KIBOU_NOTE] [nvarchar](255) COLLATE Japanese_CI_AS  NULL,
	...
	[OTHER_NOTE] [nvarchar](255) COLLATE Japanese_CI_AS  NULL,
	...
	[ANS_SHISETSU_NAME] [nvarchar](80) COLLATE Japanese_CI_AS  NULL,
	[ANS_SHISETSU_ADDRESS] [nvarchar](128) COLLATE Japanese_CI_AS  NULL,
	[ANS_SHISETSU_TEL] [nvarchar](40) COLLATE Japanese_CI_AS  NULL,
	[ANS_SHISETSU_URL] [nvarchar](255) COLLATE Japanese_CI_AS  NULL,
	[ANS_KOUEN_KAIJO_NAME] [nvarchar](80) COLLATE Japanese_CI_AS  NULL,
	[ANS_KOUEN_KAIJO_FLOOR] [nvarchar](80) COLLATE Japanese_CI_AS  NULL,
	[ANS_IKENKOUKAN_KAIJO_NAME] [nvarchar](80) COLLATE Japanese_CI_AS  NULL,
	[ANS_IROUKAI_KAIJO_NAME] [nvarchar](80) COLLATE Japanese_CI_AS  NULL,
	[ANS_KOUSHI_ROOM_NAME] [nvarchar](80) COLLATE Japanese_CI_AS  NULL,
	[ANS_SHAIN_ROOM_NAME] [nvarchar](80) COLLATE Japanese_CI_AS  NULL,
	[ANS_MANAGER_KAIJO_NAME] [nvarchar](80) COLLATE Japanese_CI_AS  NULL,
	[ANS_KAISAI_NOTE] [nvarchar](255) COLLATE Japanese_CI_AS  NULL,

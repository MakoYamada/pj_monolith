...
CREATE TABLE [dbo].[TBL_KOUENKAI](
	...
	[ACCOUNT_CD_T] [nvarchar](10) COLLATE Japanese_CI_AS  NULL,
	[ACCOUNT_CD_TF] [nvarchar](10) COLLATE Japanese_CI_AS  NULL,
	[ZETIA_CD] [nvarchar](10) COLLATE Japanese_CI_AS  NULL,
	[BU] [nvarchar](10) COLLATE Japanese_CI_AS  NULL,
	[SANKA_YOTEI_CNT] [nvarchar](10) COLLATE Japanese_CI_AS  NULL,
	...
	[KIKAKU_TANTO_ROMA] [nvarchar](100) COLLATE Japanese_CI_AS  NULL,
	[KIKAKU_TANTO_EMAIL_PC] [nvarchar](100) COLLATE Japanese_CI_AS  NULL,
	[KIKAKU_TANTO_EMAIL_KEITAI] [nvarchar](100) COLLATE Japanese_CI_AS  NULL,
	...
	[TEHAI_TANTO_ROMA] [nvarchar](100) COLLATE Japanese_CI_AS  NULL,
	[TEHAI_TANTO_EMAIL_PC] [nvarchar](100) COLLATE Japanese_CI_AS  NULL,
	[TEHAI_TANTO_EMAIL_KEITAI] [nvarchar](100) COLLATE Japanese_CI_AS  NULL,
	[TEHAI_TANTO_KEITAI] [nvarchar](20) COLLATE Japanese_CI_AS  NULL,
	[TEHAI_TANTO_TEL] [nvarchar](20) COLLATE Japanese_CI_AS  NULL,
	[YOSAN_TF] [nvarchar](10) COLLATE Japanese_CI_AS  NULL,
	[YOSAN_T] [nvarchar](10) COLLATE Japanese_CI_AS  NULL,

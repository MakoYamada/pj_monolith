...
Public Class SQL
    ...
    Public Class TBL_KOTSUHOTEL
        ...
        Public Shared Function Update_ANS_TICKET_SEND_DAY(ByVal TBL_KOTSUHOTEL As TableDef.TBL_KOTSUHOTEL.DataStruct) As String
            Dim strSQL As String = ""
    ...
    Public Class TBL_SEISAN_TKTNO
        ...
        Public Shared Function GrpByKOUENKAI_NO() As String
            ...
            strSQL &= ", TBL_SEISAN_TKTNO.SEISAN_YM"
            strSQL &= ", TBL_SEISAN_TKTNO.SEISAN_DANTAI"
            strSQL &= ", TBL_SEISAN_TKTNO.SEISAN_COMMENT"
            strSQL &= ", WK_KOUENKAI.KOUENKAI_NAME"
            strSQL &= ", WK_KOUENKAI.FROM_DATE"

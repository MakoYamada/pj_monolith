Public Class AppConst
    ...
    Public Class KAIJO
        ...
        Public Class REQ_STATUS_TEHAI
            ...
            Public Class Name
                ...
                Public Const NewRequest As String = " 本予約手配依頼"
                Public Const Change As String = "変更依頼"
                Public Const Cancel As String = "取消依頼"
                Public Const After As String = "事後登録"
            End Class
    ...
    Public Class SEISAN
        ...
        '精算処理　開始日
        Public Const START_DAY As String = "11"
    End Class
    ...
    Public Class TBL_LOG
        Public Class SYORI_KBN
            Public Class Code
                ...
                Public Const MANUALBAT As String = "3"
            End Class
            Public Class Name
                Public Const GAMEN As String = "画面"
                Public Const BATCH As String = "バッチ"
                Public Const MANUALBAT As String = "手動取込"
            End Class
        End Class
        ...
        Public Class SYORI_NAME
            Public Class BATCH
                ...
                End Class
            End Class
            Public Class MANUALBAT
                Public Class Name
                    Public Const ImportKouenkaiManual As String = "会合基本情報ファイル手動取込"
                    Public Const ImportKaijoManual As String = "会場手配ファイル手動取込"
                    Public Const ImportKotsuHotelManu As String = "交通宿泊手配依頼ファイル手動取込"
                End Class
            End Class
            Public Class GAMEN
                Public Class Name
                    ...
                    Public Const SeisanMaintenance As String = "精算データメンテナンス"

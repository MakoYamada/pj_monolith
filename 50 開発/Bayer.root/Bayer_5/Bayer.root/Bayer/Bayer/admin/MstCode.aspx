...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
					...
					<tr>
						<td align="left" colspan="2">
							...
							<asp:DropDownList ID="JokenCODE" runat="server" Width="250px">
								...
								<asp:ListItem Value="11" Text="ホテル部屋タイプ"></asp:ListItem>
								<asp:ListItem Value="12" Text="タクシーチケット券種"></asp:ListItem>
								<asp:ListItem Value="13" Text="タクシーチケット発券手数料"></asp:ListItem>
							</asp:DropDownList>
						</td>
						<td align="right">&nbsp;&nbsp;
	...
	<hr style="width: 100%;" />
	<table cellspacing="0" cellpadding="2" border="0" id="TblRegist1" runat="server">
		<tr>
			<td align="left">
							...
							<table cellpadding="2" cellspacing="2" border="0">
								...
								<tr>
									<td align="center" style="width: 60px;">
										<asp:TextBox ID="DISP_VALUE1" runat="server" Width="50px" MaxLength="10"></asp:TextBox>
									</td>
									<td align="center" style="width: 280px;">
										<asp:TextBox ID="DISP_TEXT1" runat="server" Width="270px" MaxLength="50"></asp:TextBox>
									</td>
									<td align="right" style="width: 130px;" valign="top">
										<asp:Button ID="BtnInsert1" runat="server" Text="登録" Width="100px" CssClass="Button" />
										&nbsp;
									</td>
								</tr>
							</table>
					...
					<tr>
						<td align="left">
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td align="left">
										<asp:GridView ID="GrvList1" runat="server" TabIndex="-1" CellPadding="2" CellSpacing="2" GridLines="None"
						...
						<td align="right" style="width: 132px;" valign="top">
							...
							<asp:Button ID="BtnUpdate1" runat="server" Text="変更" Width="100px" CssClass="Button" />
							&nbsp;
						</td>
					</tr>
				</table>
	...
	<table cellspacing="0" cellpadding="2" border="0" id="TblRegist2" runat="server">
		<tr>
			<td align="left">
				<table cellpadding="2" cellspacing="0" border="0" id="Table1" runat="server" style="border: 1px solid  #738891;">
					<tr style="background-color: #738891;">
						<td align="left" style="font-weight: bold; color: #ffffff;">
							新しい部屋タイプを追加
						</td>
					...
					<tr>
						<td align="left">
							<table cellpadding="2" cellspacing="2" border="0">
								...
								<tr>
									<td align="center" style="width: 280px;">
										<asp:TextBox ID="DISP_TEXT2" runat="server" Width="270px" MaxLength="50"></asp:TextBox>
									</td>
									<td align="right" style="width: 130px;" valign="top">
										<asp:Button ID="BtnInsert2" runat="server" Text="登録" Width="100px" CssClass="Button" />
										&nbsp;
									</td>
								</tr>
							</table>
		...
		<tr>
			<td align="left">
				<table cellpadding="2" cellspacing="0" border="0" id="TblUpdate2" runat="server" style="border: 1px solid  #738891;">
					<tr style="background-color: #738891;">
						<td align="left" style="font-weight: bold; color: #ffffff;" colspan="2">
							部屋タイプ名称の変更
						</td>
					...
					<tr>
						<td align="left">
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td align="left">
										<asp:GridView ID="GrvList2" runat="server" TabIndex="-1" CellPadding="2" CellSpacing="2" GridLines="None"
										 AutoGenerateColumns="false" ShowHeader="true" ShowFooter="false" 
										 AllowPaging="false" PageSize="10"
										 DataKeyNames="CODE,DATA_ID" DataSourceID="SqlDataSource1">
											<HeaderStyle Wrap="false" HorizontalAlign="Center" CssClass="TdTitle" />
											...
											<PagerStyle BackColor="#ffffff" Font-Bold="true" CssClass="pagerlink" />
											<Columns>
												<asp:BoundField DataField="DISP_VALUE" />
												<asp:TemplateField HeaderText="名称" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="280px">
													<ItemTemplate>
														<asp:TextBox ID="DISP_TEXT" runat="server" Width="270px" MaxLength="50"></asp:TextBox>
													</ItemTemplate>
						...
						<td align="right" style="width: 132px;" valign="top">
							<div class="FontSize1" style="height: 2px;"></div>
							<asp:Button ID="BtnUpdate2" runat="server" Text="変更" Width="100px" CssClass="Button" />
							&nbsp;
						</td>
					</tr>
				</table>
	...
	<table cellspacing="0" cellpadding="2" border="0" id="TblRegist3" runat="server">
		<tr>
			<td align="left">
				<table cellpadding="2" cellspacing="0" border="0" id="TblUpdate3" runat="server" style="border: 1px solid  #738891;">
					<tr style="background-color: #738891;">
						<td align="left" style="font-weight: bold; color: #ffffff;" colspan="2">
							タクシーチケット発券手数料の変更
						</td>
							...
							<table cellpadding="2" cellspacing="2" border="0">
								...
								<tr>
									<td align="center" style="width: 130px;">
										<asp:TextBox ID="DISP_TEXT3" runat="server" Width="120px" MaxLength="10"></asp:TextBox>
									</td>
									<td align="right" style="width: 130px;" valign="top">
										<asp:Button ID="BtnUpdate3" runat="server" Text="変更" Width="100px" CssClass="Button" />
										&nbsp;
									</td>
								</tr>
							</table>

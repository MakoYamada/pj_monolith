...
Public Class Proc
    ...
    Private Const pbatchID As String = "ImportKouenkaiManual" 'バッチID
...
#Region "ファイル項目"
    ...
    Private Class COL_NAME
        ...
        Public Const Field42 As String = "WBSElement"
    End Class
#End Region
    ...
    Private Sub InsertTBL_LOG(ByVal status As String, ByVal strMsg As String, Optional ByVal tableName As String = "", Optional ByVal strSQL As String = "")
        ...
        TBL_LOG.SYORI_NAME = "会合基本情報ファイル手動取込"
    ...
    Private Function SetInsData(ByVal fileData As String()) As TableDef.TBL_KOUENKAI.DataStruct
        ...
        If fileData(COL_NO.Field16).Trim = "" Then
            TBL_KOUENKAI_Ins.SANKA_YOTEI_CNT_NMBR = "0"
        Else
            TBL_KOUENKAI_Ins.SANKA_YOTEI_CNT_NMBR = CInt(fileData(COL_NO.Field16))
        End If
        If fileData(COL_NO.Field17).Trim = "" Then
            TBL_KOUENKAI_Ins.SANKA_YOTEI_CNT_MBR = "0"
        Else
            TBL_KOUENKAI_Ins.SANKA_YOTEI_CNT_MBR = CInt(fileData(COL_NO.Field17))
        End If
        '2015/6/15 End
        ...
        If UCase(fileData(COL_NO.Field18)) = "TRUE" Then
            TBL_KOUENKAI_Ins.SRM_HACYU_KBN = AppConst.KAIJO.SRM_HACYU_KBN.Code.Yes
        ElseIf UCase(fileData(COL_NO.Field18)) = "FALSE" Then
            TBL_KOUENKAI_Ins.SRM_HACYU_KBN = AppConst.KAIJO.SRM_HACYU_KBN.Code.No
        Else
            TBL_KOUENKAI_Ins.SRM_HACYU_KBN = fileData(COL_NO.Field18)
        End If
        '2015/6/15 End
        ...
        If fileData(COL_NO.Field38).Trim = "" Then
            TBL_KOUENKAI_Ins.YOSAN_TF = "0"
        Else
            TBL_KOUENKAI_Ins.YOSAN_TF = CLng(fileData(COL_NO.Field38))
        End If
        If fileData(COL_NO.Field39).Trim = "" Then
            TBL_KOUENKAI_Ins.YOSAN_T = "0"
        Else
            TBL_KOUENKAI_Ins.YOSAN_T = CLng(fileData(COL_NO.Field39))
        End If
        If fileData(COL_NO.Field40).Trim = "" Then
            TBL_KOUENKAI_Ins.IROUKAI_YOSAN_T = "0"
        Else
            TBL_KOUENKAI_Ins.IROUKAI_YOSAN_T = CLng(fileData(COL_NO.Field40))
        End If
        If fileData(COL_NO.Field41).Trim = "" Then
            TBL_KOUENKAI_Ins.IKENKOUKAN_YOSAN_T = "0"
        Else

<%@ Page Title=""  Language="vb" AutoEventWireup="false" MasterPageFile="~/Base.Master" CodeBehind="KouenkaiRireki.aspx.vb" Inherits="Bayer_Past.KouenkaiRireki" %>
		...
		<tr>
		    <td>
		    	...
		    	<asp:GridView ID="GrvList" runat="server" TabIndex="-1" CellPadding="2" 
				 ...
				 DataKeyNames="KOUENKAI_NO" DataSourceID="SqlDataSource1" Width="900px">

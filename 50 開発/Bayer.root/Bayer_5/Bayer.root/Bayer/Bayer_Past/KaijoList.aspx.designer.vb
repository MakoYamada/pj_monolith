...
Partial Public Class KaijoList
    ...
    '''<summary>
    '''JokenKIKAKU_TANTO_NAME コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナ ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents JokenKIKAKU_TANTO_NAME As Global.System.Web.UI.WebControls.TextBox
    ...
    '''<summary>
    '''JokenTEHAI_TANTO_NAME コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナ ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents JokenTEHAI_TANTO_NAME As Global.System.Web.UI.WebControls.TextBox

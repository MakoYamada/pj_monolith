...
#Region "デリゲート"
    ...
    Public Function CsvMethod(ByVal intLoop As Integer, ByRef format As String) As String
        ...
        sb.Append(CmnCsv.SetData(CmnCsv.Quotes("その他鉄道等取消料(込)")))
        ...
        sb.Append(CmnCsv.SetData(CmnCsv.Quotes("タクチケ発地")))
        sb.Append(CmnCsv.SetData(CmnCsv.Quotes("タクチケ着地")))
        ...
        sb.Append(CmnCsv.SetData(CmnCsv.Quotes("タクチケTTT備考"), True))
        sb.Append(vbNewLine)
        ...
        While RsData2.Read()
            ...
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_TAXI_RMKS), True))
            sb.Append(vbNewLine)
...
#End Region
    ...
    Private Sub BtnDL_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnDL.Click
        ...
        Response.AppendHeader(CmnConst.Csv.AppendHeader1, CmnConst.Csv.AppendHeader2 & HttpUtility.UrlEncode("タクチケ一覧(過去データ)_" & Me.JokenSHOUNIN_Y.Text & Me.JokenSHOUNIN_M.Text & "_" & Now.ToString("yyyyMMddHHmmss") & ".csv"))

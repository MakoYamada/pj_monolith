<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Base.Master" CodeBehind="DrRireki.aspx.vb" Inherits="Bayer_Past.DrRireki" %>
...
<ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                        ...
                        <asp:BoundField DataField="DR_MPID" HeaderText="DR_MPID" />
                    </Columns>
                </asp:GridView>
            </td>
        </tr>

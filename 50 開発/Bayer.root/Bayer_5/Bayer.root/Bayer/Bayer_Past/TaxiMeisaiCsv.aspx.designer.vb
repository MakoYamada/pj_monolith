...
Partial Public Class TaxiMeisaiCsv
    ...
    '''<summary>
    '''JokenTKT_ENTA_ALL コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナ ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents JokenTKT_ENTA_ALL As Global.System.Web.UI.WebControls.RadioButton

    '''<summary>
    '''JokenTKT_ENTA_N_Igai コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナ ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents JokenTKT_ENTA_N_Igai As Global.System.Web.UI.WebControls.RadioButton

    '''<summary>
    '''JokenTKT_ENTA_N_Only コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナ ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents JokenTKT_ENTA_N_Only As Global.System.Web.UI.WebControls.RadioButton

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SapCsv.aspx.vb" Inherits="Bayer.SapCsv" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
	<title id="Title1" runat="server">SAP用CSVデータ生成</title>
            ...
            <div style="padding: 10px; margin-bottom: 10px; border: 1px solid #cccccc; width: 100%">
                <table cellspacing="0" cellpadding="2" border="0" width="100%">
                    ...
                    <tr>
                        <td style="text-align:left" class="style1">
                            注文番号 &nbsp;
                            <%--例)450000<a style="color:Red">XXXX</a> --%>
                            例)<a style="color:Red">XXXXXXXXXX</a>
                        </td>
                        <td align="left" style="width:200px">
                    ...
                    <tr>
                        <td style="text-align:left" class="style1">
                            Cost Center &nbsp;
                            <%--例)YA00627<a style="color:Red">XXX</a> --%>
                            例)<a style="color:Red">XXXXXXXXXX</a> 
                        </td>
                        <td align="left" style="width:200px">

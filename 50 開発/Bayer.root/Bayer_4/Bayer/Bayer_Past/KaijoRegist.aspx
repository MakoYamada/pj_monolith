<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Base.Master" CodeBehind="KaijoRegist.aspx.vb" Inherits="Bayer_Past.KaijoRegist" MaintainScrollPositionOnPostback="true" %>
	...
	<table cellspacing="0" cellpadding="0" border="0" style="width: 940px; margin-bottom: 10px;">
		<tr>
			...
			<td nowrap="nowrap" align="right">
				<asp:Button ID="BtnNozomi1" runat="server" Width="150px" Text="NOZOMIへ" CssClass="Button" Visible="false" />
				<asp:Button ID="BtnSubmit1" runat="server" Width="150px" Text="登録" CssClass="Button" Visible="false" />
				<asp:Button ID="BtnBack1" runat="server" Width="150px" Text="戻る" CssClass="Button"/>
			</td>
		</tr>
	</table>
									...
									<td nowrap="nowrap" align="left">
										...
										<table cellspacing="2" border="0">
											<tr>
												...
												<td nowrap="nowrap" align="left" class="TdItemKaijo" colspan="4">
													<asp:TextBox ID="ANS_SENTEI_RIYU" runat="server" 
                                                        Text="◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎" Width="650px" MaxLength="255" 
											...
											<tr>
												...
												<td nowrap="nowrap" align="left" class="TdItemKaijo" style="width: 330px;">
													<asp:TextBox ID="ADDRESS2" runat="server" Text="◎◎◎◎◎◎◎◎◎◎" Width="350px" MaxLength="100" BackColor="#f4f9cd"></asp:TextBox>
												</td>
												<td nowrap="nowrap">&nbsp;</td>
											</tr>
											<tr>
												...
												<td nowrap="nowrap" align="left" class="TdItemKaijo" colspan="4">
													<asp:TextBox ID="ANS_SHISETSU_NAME" runat="server" Text="◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎" Width="550px" MaxLength="80" BackColor="#f4f9cd"></asp:TextBox>
													&nbsp;
													<asp:Button ID="BtnShisetsuKensaku" runat="server" Text="検索" Width="50px" CssClass="ButtonList" />
													&nbsp;
													<asp:Button ID="BtnShisetsuClear" runat="server" Text="クリア" Width="50px" CssClass="ButtonList" />
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td nowrap="nowrap" align="left" class="TdItemKaijo" colspan="4">
													<asp:TextBox ID="ANS_KAISAI_NOTE" runat="server" 
                                                        Text="◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎" Width="650px" MaxLength="255" 
                                                        TextMode="MultiLine"></asp:TextBox>
												</td>
											</tr>
									...
									<td nowrap="nowrap" align="left" style="border: 1px solid #a8a8a8;">
										<table cellspacing="2" border="0" style="width: 220px;">
											...
											<tr>
												...
												<td nowrap="nowrap" align="left" class="TdItemKaijo">
													<asp:Button ID="BtnCalc_ANS_TOTAL_TF" runat="server" Text="再計算" Width="60px" CssClass="ButtonList"  Visible="false"/>
												</td>
												<td>&nbsp;</td>
											</tr>
										</table>
									...
									<td nowrap="nowrap" align="left" style="border: 1px solid #a8a8a8;">
										<table cellspacing="2" border="0" style="width: 220px;">
											...
											<tr>
												...
												<td nowrap="nowrap" align="left" class="TdItemKaijo">
													<asp:Button ID="BtnCalc_ANS_TOTAL_T" runat="server" Text="再計算" Width="60px" CssClass="ButtonList"  Visible="false"/>
												</td>
												<td>&nbsp;</td>
											</tr>
										</table>
									...
									<td nowrap="nowrap" align="left">
										<table cellspacing="2" border="0">
											<tr>
												...
												<td nowrap="nowrap" align="left" class="TdItemKaijo">
													<asp:Button ID="BtnCalc_ANS_MITSUMORI" runat="server" Text="再計算" Width="60px" CssClass="ButtonList" Visible="false" />
												</td>
											</tr>
										</table>
									</td>
			...
			<td nowrap="nowrap" align="left">
				<table cellspacing="0" cellpadding="2" border="0" style="width: 940px;">
					<tr style="height: 36px;">
						...
						<td>&nbsp;</td>
						<td nowrap="nowrap" align="right">
							<asp:Button ID="BtnNozomi2" runat="server" Width="150px" Text="NOZOMIへ" CssClass="Button" Visible="false" />
							<asp:Button ID="BtnSubmit2" runat="server" Width="150px" Text="登録" CssClass="Button" Visible="false" />
							<asp:Button ID="BtnBack2" runat="server" Width="150px" Text="戻る" CssClass="Button" />
						</td>
					</tr>
				</table>
			</td>

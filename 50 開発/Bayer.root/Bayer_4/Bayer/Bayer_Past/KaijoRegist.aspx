	...
	<table cellspacing="0" cellpadding="0" border="0" style="width: 940px; margin-bottom: 10px;">
		<tr>
			...
			<td nowrap="nowrap" align="right">
				<asp:Button ID="BtnNozomi1" runat="server" Width="150px" Text="NOZOMIへ" CssClass="Button" />
				<asp:Button ID="BtnSubmit1" runat="server" Width="150px" Text="登録" CssClass="Button" />
			...
			<td nowrap="nowrap" align="left">
				<table cellspacing="0" cellpadding="2" border="0" style="width: 940px;">
					<tr style="height: 36px;">
						...
						<td>&nbsp;</td>
						<td nowrap="nowrap" align="right">
							<asp:Button ID="BtnNozomi2" runat="server" Width="150px" Text="NOZOMIへ" CssClass="Button" />
							<asp:Button ID="BtnSubmit2" runat="server" Width="150px" Text="登録" CssClass="Button" />

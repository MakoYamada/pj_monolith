...
#Region "デリゲート"
    ...
    Public Function CsvMethod(ByVal intLoop As Integer, ByRef format As String) As String
        ...
        sb.Append(CmnCsv.SetData(CmnCsv.Quotes("社員宿泊費(込)")))
        sb.Append(CmnCsv.SetData(CmnCsv.Quotes("社員宿泊取消料(込)")))
        ...
        sb.Append(CmnCsv.SetData(CmnCsv.Quotes("")))
        sb.Append(CmnCsv.SetData(CmnCsv.Quotes("")))
        sb.Append(CmnCsv.SetData(CmnCsv.Quotes(KEI_GOUKEI), True))
        sb.Append(vbNewLine)
        rtnStr = sb.ToString
...
#End Region
    ...
    Private Sub BtnDL_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnDL.Click
        ...
        Response.AppendHeader(CmnConst.Csv.AppendHeader1, CmnConst.Csv.AppendHeader2 & HttpUtility.UrlEncode("社員旅費一覧表(過去データ)_" & Me.JokenSHOUNIN_Y.Text & Me.JokenSHOUNIN_M.Text & "_" & Now.ToString("yyyyMMddHHmmss") & ".csv"))

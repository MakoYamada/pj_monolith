...
Partial Public Class KouenkaiRegist
    ...
    Private Sub SetForm()
        ...
        Me.WBS_ELEMENT.Text = AppModule.GetName_WBS_ELEMENT(DSP_KOUENKAI.WBS_ELEMENT)   '@@@ Phase3 ADD
        ...
        If Not Popup Then
            ...
            SetChangedColor(Me.WBS_ELEMENT, DSP_KOUENKAI.WBS_ELEMENT, OldTBL_KOUENKAI.WBS_ELEMENT)

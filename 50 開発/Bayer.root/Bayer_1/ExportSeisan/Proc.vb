    ...
    Private Function CreateFile(ByVal fileName As String, ByVal CsvData() As TableDef.TBL_SEIKYU.DataStruct) As Boolean
        ...
        Try
            ...
            For wCnt As Integer = 0 To UBound(CsvData)
                ...
                Dim lngInshokuHi As Long = CmnModule.DbVal_Kingaku(CsvData(wCnt).INSHOKUHI_T) + _
                                         CmnModule.DbVal_Kingaku(CsvData(wCnt).IROUKAIHI_T)
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(lngInshokuHi.ToString)))

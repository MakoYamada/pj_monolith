Public Class CmnDb_bk
    ...
    Public Shared Function ReadForDeligate(ByVal strSQL As String, ByVal DbConn As SqlClient.SqlConnection) As SqlClient.SqlDataReader
        Dim pDbConnection As SqlClient.SqlConnection
        Dim DbCmd As System.Data.SqlClient.SqlCommand
        ...
        Try
            ...
            If pDbConnection.State <> ConnectionState.Open Then
                DbOpen(pDbConnection)
            End If
            DbCmd = New System.Data.SqlClient.SqlCommand(strSQL, pDbConnection)

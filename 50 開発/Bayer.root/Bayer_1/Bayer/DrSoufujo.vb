...
Public Class DrSoufujo
    ...
    Public WriteOnly Property LoginID() As String
    ...
    Private Sub DrSoufujo_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart

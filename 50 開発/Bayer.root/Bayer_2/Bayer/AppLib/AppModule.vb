...
#Region "請求テーブル"
    Public Shared Function SetRsData(ByVal RsData As System.Data.SqlClient.SqlDataReader, ByVal TBL_SEIKYU As TableDef.TBL_SEIKYU.DataStruct) As TableDef.TBL_SEIKYU.DataStruct
        ...
        For wCnt = 0 To RsData.FieldCount - 1
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_SEIKYU.Column.IROUKAIHI_T.ToUpper Then TBL_SEIKYU.IROUKAIHI_T = CmnDb.DbData(RsData.GetName(wCnt), RsData)
    ...
    Public Shared Function GetOneRecord(ByVal TableType As TableType, ByVal SQL As String, ByVal DbConn As System.Data.SqlClient.SqlConnection) As Object
        ...
        Select Case TableType
            ...
            Case AppModule.TableType.TBL_KOTSUHOTEL
                ...
                RsData.Close()
                Return TBL_KOTSUHOTEL
            Case AppModule.TableType.TBL_TAXITICKET_HAKKO
                Dim TBL_TAXITICKET_HAKKO As TableDef.TBL_TAXITICKET_HAKKO.DataStruct = Nothing
                RsData = CmnDb.Read(SQL, DbConn)
                If RsData.Read() Then
                    TBL_TAXITICKET_HAKKO = SetRsData(RsData, TBL_TAXITICKET_HAKKO)
                End If
                RsData.Close()
                Return TBL_TAXITICKET_HAKKO
...
#Region "未決登録"
    Public Shared Function GetName_TKT_KAISHA(ByVal TKT_KAISHA As String) As String
        ...
        For wCnt As Integer = 0 To MS_CODE.Count - 1
            ...
            If MS_CODE(wCnt).CODE = AppConst.MS_CODE.TAXI_KAISHA AndAlso MS_CODE(wCnt).DISP_VALUE = TKT_KAISHA Then
                wStr = MS_CODE(wCnt).DISP_TEXT
                Exit For
            End If
        Next
...
#Region "交通・宿泊手配回答登録画面　画面項目表示"
    ...
    End Sub
    Public Shared Sub SetForm_KOUENKAI_NO(ByVal KOUENKAI_NO As String, ByRef control As TextBox)
        control.Text = KOUENKAI_NO
    End Sub
    ...
    '精算番号
    Public Shared Sub SetForm_SEIKYU_NO_TOPTOUR(ByVal SEIKYU_NO_TOPTOUR As String, ByRef control As TextBox)
        control.Text = SEIKYU_NO_TOPTOUR
    End Sub
    ...
    'タクシーチケット：利用日（回答）
    Public Shared Sub SetForm_ANS_TAXI_DATE(ByVal ANS_TAXI_DATE As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        control.Text = ANS_TAXI_DATE
        If ANS_TAXI_HAKKO_DATE.Trim <> "" AndAlso DATA_MAINTENANCE = CmnConst.Flag.Off Then
            control.Enabled = False
        ElseIf SEIKYU_NO_TOPTOUR.Trim <> "" Then
            control.Enabled = False
        Else
            control.Enabled = True
        End If
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_1(ByVal ANS_TAXI_DATE_1 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        'SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_1, control, ANS_TAXI_HAKKO_DATE, DATA_MAINTENANCE)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_1, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_2(ByVal ANS_TAXI_DATE_2 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_2, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_3(ByVal ANS_TAXI_DATE_3 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_3, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_4(ByVal ANS_TAXI_DATE_4 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_4, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_5(ByVal ANS_TAXI_DATE_5 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_5, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_6(ByVal ANS_TAXI_DATE_6 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_6, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_7(ByVal ANS_TAXI_DATE_7 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_7, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_8(ByVal ANS_TAXI_DATE_8 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_8, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_9(ByVal ANS_TAXI_DATE_9 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_9, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_10(ByVal ANS_TAXI_DATE_10 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_10, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_11(ByVal ANS_TAXI_DATE_11 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_11, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_12(ByVal ANS_TAXI_DATE_12 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_12, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_13(ByVal ANS_TAXI_DATE_13 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_13, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_14(ByVal ANS_TAXI_DATE_14 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_14, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_15(ByVal ANS_TAXI_DATE_15 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_15, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_16(ByVal ANS_TAXI_DATE_16 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_16, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_17(ByVal ANS_TAXI_DATE_17 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_17, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_18(ByVal ANS_TAXI_DATE_18 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_18, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_19(ByVal ANS_TAXI_DATE_19 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_19, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_DATE_20(ByVal ANS_TAXI_DATE_20 As String, ByRef control As TextBox, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENANCE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_DATE(ANS_TAXI_DATE_20, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENANCE)
    End Sub

    'タクシーチケット：券種（回答）
    Public Shared Sub SetForm_ANS_TAXI_KENSHU(ByVal ANS_TAXI_KENSHU As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        control.SelectedIndex = CmnModule.GetSelectedIndex(ANS_TAXI_KENSHU, control, True)
        If ANS_TAXI_HAKKO_DATE.Trim <> "" AndAlso DATA_MAINTENACE = CmnConst.Flag.Off Then
            control.Enabled = False
        ElseIf SEIKYU_NO_TOPTOUR.Trim <> "" Then
            control.Enabled = False
        Else
        ...
        End If
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_1(ByVal ANS_TAXI_KENSHU_1 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_1, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_2(ByVal ANS_TAXI_KENSHU_2 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_2, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_3(ByVal ANS_TAXI_KENSHU_3 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_3, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_4(ByVal ANS_TAXI_KENSHU_4 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_4, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_5(ByVal ANS_TAXI_KENSHU_5 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_5, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_6(ByVal ANS_TAXI_KENSHU_6 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_6, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_7(ByVal ANS_TAXI_KENSHU_7 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_7, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_8(ByVal ANS_TAXI_KENSHU_8 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_8, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_9(ByVal ANS_TAXI_KENSHU_9 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_9, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_10(ByVal ANS_TAXI_KENSHU_10 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_10, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_11(ByVal ANS_TAXI_KENSHU_11 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_11, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_12(ByVal ANS_TAXI_KENSHU_12 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_12, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_13(ByVal ANS_TAXI_KENSHU_13 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_13, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_14(ByVal ANS_TAXI_KENSHU_14 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_14, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_15(ByVal ANS_TAXI_KENSHU_15 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_15, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_16(ByVal ANS_TAXI_KENSHU_16 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_16, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_17(ByVal ANS_TAXI_KENSHU_17 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_17, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_18(ByVal ANS_TAXI_KENSHU_18 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_18, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_19(ByVal ANS_TAXI_KENSHU_19 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_19, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
    Public Shared Sub SetForm_ANS_TAXI_KENSHU_20(ByVal ANS_TAXI_KENSHU_20 As String, ByRef control As DropDownList, ByVal ANS_TAXI_HAKKO_DATE As String, ByVal SEIKYU_NO_TOPTOUR As String, Optional ByVal DATA_MAINTENACE As String = CmnConst.Flag.Off)
        SetForm_ANS_TAXI_KENSHU(ANS_TAXI_KENSHU_20, control, ANS_TAXI_HAKKO_DATE, SEIKYU_NO_TOPTOUR, DATA_MAINTENACE)
    End Sub
...
#Region "精算入力画面　画面項目表示"
    ...
    Public Shared Sub SetForm_SEISAN_KANRYO(ByVal SEISAN_KANRYO As String, ByRef control As CheckBox)
        ...
        End If
    End Sub
    Public Shared Sub SetForm_SEISAN_KANRYO(ByVal SEISAN_KANRYO As String, ByRef control As Label)
        If SEISAN_KANRYO = CmnConst.Flag.On Then
            control.Text = AppConst.SEISAN.SEISAN_KANRYO.Name.Kanryo
        Else
            control.Text = AppConst.SEISAN.SEISAN_KANRYO.Name.Mi
        End If
    End Sub
...
#Region "未決登録画面　画面項目表示"
    ...
    End Sub
    Public Shared Sub SetForm_TKT_LINE_NO(ByVal TKT_LINE_NO As String, ByRef control As TextBox)
        control.Text = TKT_LINE_NO.Trim
    End Sub
    ...
    '請求年月
    Public Shared Sub SetForm_TKT_SEIKYU_YM(ByVal TKT_SEIKYU_YM As String, ByRef control As Label)
        control.Text = CmnModule.Format_Date(TKT_SEIKYU_YM, CmnModule.DateFormatType.YYYYMM)
    End Sub
    Public Shared Sub SetForm_TKT_SEIKYU_YM(ByVal TKT_SEIKYU_YM As String, ByRef control As TextBox)
        control.Text = TKT_SEIKYU_YM.Trim
    End Sub
    ...
    Public Shared Sub SetForm_TKT_VOID(ByVal TKT_VOID As String, ByVal UPDATE_DATE As String, ByRef control As Label)
        ...
        End If
    End Sub
    Public Shared Sub SetForm_TKT_VOID(ByVal TKT_VOID As String, ByVal UPDATE_DATE As String, ByRef control As TextBox)
        If TKT_VOID = CmnConst.Flag.On Then
            control.Text = CmnModule.Format_Date(UPDATE_DATE, CmnModule.DateFormatType.YYYYMMDD).Replace("/", "")
        Else
            control.Text = ""
        End If
    End Sub
    ...
    '実車代金
    Public Shared Sub SetForm_TKT_URIAGE(ByVal TKT_URIAGE As String, ByRef control As TextBox)
        control.Text = TKT_URIAGE.Trim
    End Sub

    '精算手数料
    Public Shared Sub SetForm_TKT_SEISAN_FEE(ByVal TKT_SEISAN_FEE As String, ByRef control As TextBox)
        control.Text = TKT_SEISAN_FEE.Trim
    End Sub

    '発行手数料
    Public Shared Sub SetForm_TKT_HAKKO_FEE(ByVal TKT_HAKKO_FEE As String, ByRef control As TextBox)
        control.Text = TKT_HAKKO_FEE.Trim
    End Sub

    'エンタ
    Public Shared Sub SetForm_TKT_ENTA(ByVal TKT_ENTA As String, ByRef control As TextBox)
        control.Text = TKT_ENTA.Trim
    End Sub
...
#Region "ログ照会 画面名"
    ...
    Public Class SetDropDownList_SYORI_NAME
        ...
        Public Shared Sub LogSousa(ByRef SYORI_NAME As DropDownList)
            ...
            End With
        End Sub
        Public Shared Sub LogManual(ByRef SYORI_NAME As DropDownList)
            With SYORI_NAME
                .Items.Clear()
                .Items.Add(New ListItem("---", ""))
                .Items.Add(New ListItem(AppConst.TBL_LOG.SYORI_NAME.MANUALBAT.Name.ImportKouenkaiManual, AppConst.TBL_LOG.SYORI_NAME.MANUALBAT.Name.ImportKouenkaiManual))
                .Items.Add(New ListItem(AppConst.TBL_LOG.SYORI_NAME.MANUALBAT.Name.ImportKaijoManual, AppConst.TBL_LOG.SYORI_NAME.MANUALBAT.Name.ImportKaijoManual))
                .Items.Add(New ListItem(AppConst.TBL_LOG.SYORI_NAME.MANUALBAT.Name.ImportKotsuHotelManu, AppConst.TBL_LOG.SYORI_NAME.MANUALBAT.Name.ImportKotsuHotelManu))
            End With
        End Sub
    End Class
#End Region
...
#Region "送信フラグ"
    Public Shared Sub SetDropDownList_SEND_FLAG(ByRef SEND_FLAG As DropDownList)
        ...
        End With
    End Sub
    Public Shared Sub SetDropDownList_SEND_FLAG_ForSEISAN(ByRef SEND_FLAG As DropDownList)
        With SEND_FLAG
            .Items.Clear()
            .Items.Add(New ListItem(AppConst.SEND_FLAG.Name.Mi, AppConst.SEND_FLAG.Code.Mi))
            .Items.Add(New ListItem(AppConst.SEND_FLAG.Name.Taisho, AppConst.SEND_FLAG.Code.Taisho))
...
#Region "== コントロールからDB用の値を返す =="
    ...
    '精算番号
    Public Shared Function GetValue_SEIKYU_NO_TOPTOUR(ByVal SEIKYU_NO_TOPTOUR As TextBox) As String
        Return SEIKYU_NO_TOPTOUR.Text.Trim
    End Function

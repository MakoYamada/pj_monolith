<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Base.Master" CodeBehind="Menu_Phase2.aspx.vb" Inherits="Bayer.Menu_Phase2" %>
			...
			<td align="center">
				<table cellpadding="3" cellspacing="2" border="0">
					...
					<tr valign="top">
						...
						<td align="center" style="width: 210px;">
							<asp:Button ID="BtnBunseki" runat="server" Text="分析用データ作成" Width="200px" CssClass="Button" />
						</td>
						<td align="center" style="width: 210px;">

Imports CommonLib
Imports AppLib
Partial Public Class SapCsv_bk
    Inherits WebBase
...
#Region "SAP用CSV　処理"
    ...
    Private Function CreateCSVData(ByVal SeikyuData() As TableDef.TBL_SEIKYU.DataStruct, Optional ByVal isTopTour As Boolean = False) As TableDef.SAP_CSV.DataStruct()
        ...
        csvData(rowCnt).ASSIGNMENT = "ZUONR"    '2014/12/11 ADD
        ...
        For wCnt As Integer = 0 To UBound(SeikyuData)
            ...
            SetMrHotelRecord(SeikyuData(wCnt), csvData, rowCnt, lngTotalKingaku, strSapZeiCd, MyBase.DbConnection, isTopTour)
            'タクチケ(課税)
        ...
        If GetMrRyohiData(SeikyuData.KOUENKAI_NO, SeikyuData.SEIKYU_NO_TOPTOUR, MrData, DbConn) Then
            ...
            For wCnt As Integer = 0 To UBound(MrData)
                ...
                If Kingaku <> 0 Then
                    ...
                    csvData(rowCnt).ACCOUNT = "6829000" '2014/1/6 UPDATE
                    csvData(rowCnt).KINGAKU = Kingaku.ToString
                    csvData(rowCnt).ZEI_CD = strSapZeiCd
    ...
    Private Sub SetMrHotelRecord(ByVal SeikyuData As TableDef.TBL_SEIKYU.DataStruct, _
        ...
        Dim MrData() As TableDef.TBL_KOTSUHOTEL.DataStruct
        If GetMrHotelData(SeikyuData.KOUENKAI_NO, SeikyuData.SEIKYU_NO_TOPTOUR, MrData, DbConn) Then
            ...
            For wCnt As Integer = 0 To UBound(MrData)
                ...
                If Kingaku <> 0 Then
                    ...
                    csvData(rowCnt).XMWST = ""
                    csvData(rowCnt).NEWBS = "40"
                    csvData(rowCnt).ACCOUNT = "6821400"
                    csvData(rowCnt).KINGAKU = Kingaku.ToString
                    csvData(rowCnt).ZEI_CD = strSapZeiCd
                    csvData(rowCnt).COST_CENTER = MrData(wCnt).COST_CENTER
                    csvData(rowCnt).INTERNAL_ORDER = ""

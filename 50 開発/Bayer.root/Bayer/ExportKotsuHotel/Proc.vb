    ...
    Private Function CreateFile(ByVal fileName As String, ByVal CsvData() As TableDef.TBL_KOTSUHOTEL.DataStruct) As Boolean
        ...
        Try
            ...
            For wCnt As Integer = 0 To UBound(CsvData)
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_STATUS_HOTEL)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_HOTEL_NAME)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_HOTEL_ADDRESS)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_CHECKIN_TIME)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_CHECKOUT_TIME)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_HOTELHI, strZeiRate))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_HOTELHI_CANCEL, strZeiRate))))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_O_TIME1_1)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_O_TIME1_2)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_O_TIME1_3)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_O_TIME1_4)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_O_TIME1_5)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_F_TIME1_1)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_F_TIME1_2)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_F_TIME1_3)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_F_TIME1_4)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_F_TIME1_5)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_RAIL_FARE, strZeiRate))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_RAIL_CANCELLATION, strZeiRate))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_OTHER_FARE, strZeiRate))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_OTHER_CANCELLATION, strZeiRate))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_AIR_FARE, strZeiRate))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_AIR_CANCELLATION, strZeiRate))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_KOTSUHOTEL_TESURYO, strZeiRate))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_TAXI_TESURYO, strZeiRate))))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_MR_KOTSUHI, strZeiRate))))
                sb.Append(CmnCsv.Quotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_MR_HOTELHI, strZeiRate)))
                sb.Append(vbNewLine)
            Next wCnt

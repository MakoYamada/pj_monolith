    ...
    Private Function CreateFile(ByVal fileName As String, ByVal CsvData() As TableDef.TBL_KAIJO.DataStruct) As Boolean
        ...
        Try
            ...
            For wCnt As Integer = 0 To UBound(CsvData)
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_MITSUMORI_T, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_MITSUMORI_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_MITSUMORI_TOTAL, strZeiRate)))))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_KAIJOUHI_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_KIZAIHI_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_INSHOKUHI_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_991330401_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_HOTELHI_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_KOTSUHI_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_TAXI_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_TEHAI_TESURYO_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_TAXI_HAKKEN_TESURYO_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_TAXI_SEISAN_TESURYO_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_JINKENHI_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_OTHER_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_KANRIHI_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_41120200_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_TOTAL_TF, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_KAIJOUHI_T, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_KIZAIHI_T, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_INSHOKUHI_T, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_991330401_T, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_JINKENHI_T, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_OTHER_T, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_KANRIHI_T, strZeiRate)))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_41120200_T, strZeiRate)))))
                sb.Append(CmnCsv.Quotes(CmnCsv.EscapeQuotes(AppModule.GetZeinukiGaku(CsvData(wCnt).ANS_TOTAL_T, strZeiRate))))
                sb.Append(vbNewLine)
            Next

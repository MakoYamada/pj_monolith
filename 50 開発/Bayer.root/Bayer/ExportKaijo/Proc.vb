    ...
    Private Function CreateFile(ByVal fileName As String, ByVal CsvData() As TableDef.TBL_KAIJO.DataStruct) As Boolean
        ...
        Try
            ...
            For wCnt As Integer = 0 To UBound(CsvData)
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).TEHAI_ID)))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).KAISAI_KIBOU_ADDRESS1)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).KAISAI_KIBOU_ADDRESS2)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).KAISAI_KIBOU_NOTE)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).KOUEN_TIME1)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).KOUEN_TIME2)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).KOUEN_KAIJO_LAYOUT)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).IKENKOUKAN_KAIJO_TEHAI)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).IROUKAI_KAIJO_TEHAI)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).IROUKAI_SANKA_YOTEI_CNT)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).KOUSHI_ROOM_TEHAI)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).SHAIN_ROOM_TEHAI)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).MANAGER_KAIJO_TEHAI)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).OTHER_NOTE)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_SENTEI_RIYU)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_MITSUMORI_T)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_MITSUMORI_TF)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_MITSUMORI_TOTAL)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_MITSUMORI_URL)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_SHISETSU_NAME)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_SHISETSU_ZIP)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_SHISETSU_ADDRESS)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_SHISETSU_TEL)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_SHISETSU_URL)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_KOUEN_KAIJO_NAME)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_KOUEN_KAIJO_FLOOR)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_IKENKOUKAN_KAIJO_NAME)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_IROUKAI_KAIJO_NAME)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).ANS_KOUSHI_ROOM_NAME)))

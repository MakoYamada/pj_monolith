Public Class SessionDef
    ...
    Public ADDRESS1 As String = "ADDRESS1"
    Public ADDRESS2 As String = "ADDRESS2"
    Public SHISETSU_NAME As String = "SHISETSU_NAME"
    Public SHISETSU_NAME_KANA As String = "SHISETSU_NAME_KANA"
    Public ADDRESS As String = "ADDRESS"
    Public TEL As String = "TEL"

...
Public Class AppModule
    ...
    Public Shared Function SetRsData(ByVal RsData As System.Data.SqlClient.SqlDataReader, ByVal TBL_KOTSUHOTEL As TableDef.TBL_KOTSUHOTEL.DataStruct) As TableDef.TBL_KOTSUHOTEL.DataStruct
        ...
        For wCnt = 0 To RsData.FieldCount - 1
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.SHONIN_NOTE.ToUpper Then TBL_KOTSUHOTEL.SHONIN_NOTE = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.REQ_TAXI_NO_1.ToUpper Then TBL_KOTSUHOTEL.REQ_TAXI_NO_1 = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.REQ_TAXI_NO_2.ToUpper Then TBL_KOTSUHOTEL.REQ_TAXI_NO_2 = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.REQ_TAXI_NO_3.ToUpper Then TBL_KOTSUHOTEL.REQ_TAXI_NO_3 = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.REQ_TAXI_NO_4.ToUpper Then TBL_KOTSUHOTEL.REQ_TAXI_NO_4 = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.REQ_TAXI_NO_5.ToUpper Then TBL_KOTSUHOTEL.REQ_TAXI_NO_5 = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.REQ_TAXI_NO_6.ToUpper Then TBL_KOTSUHOTEL.REQ_TAXI_NO_6 = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.REQ_TAXI_NO_7.ToUpper Then TBL_KOTSUHOTEL.REQ_TAXI_NO_7 = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.REQ_TAXI_NO_8.ToUpper Then TBL_KOTSUHOTEL.REQ_TAXI_NO_8 = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.REQ_TAXI_NO_9.ToUpper Then TBL_KOTSUHOTEL.REQ_TAXI_NO_9 = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KOTSUHOTEL.Column.REQ_TAXI_NO_10.ToUpper Then TBL_KOTSUHOTEL.REQ_TAXI_NO_10 = CmnDb.DbData(RsData.GetName(wCnt), RsData)
    ...
    Public Shared Function SetRsData(ByVal RsData As System.Data.SqlClient.SqlDataReader, ByVal TBL_KAIJO As TableDef.TBL_KAIJO.DataStruct) As TableDef.TBL_KAIJO.DataStruct
        ...
        For wCnt = 0 To RsData.FieldCount - 1
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.MITSUMORI_URL.ToUpper Then TBL_KAIJO.MITSUMORI_URL = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.KOUENKAI_EDABAN.ToUpper Then TBL_KAIJO.KOUENKAI_EDABAN = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.KIKAKU_TANTO_JIGYOBU.ToUpper Then TBL_KAIJO.KIKAKU_TANTO_JIGYOBU = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.KIKAKU_TANTO_NO.ToUpper Then TBL_KAIJO.KIKAKU_TANTO_NO = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.KIKAKU_TANTO_KANA.ToUpper Then TBL_KAIJO.KIKAKU_TANTO_KANA = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.KIKAKU_TANTO_EMAIL.ToUpper Then TBL_KAIJO.KIKAKU_TANTO_EMAIL = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.TEHAI_TANTO_JIGYOBU.ToUpper Then TBL_KAIJO.TEHAI_TANTO_JIGYOBU = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.TEHAI_TANTO_NO.ToUpper Then TBL_KAIJO.TEHAI_TANTO_NO = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.TEHAI_TANTO_KANA.ToUpper Then TBL_KAIJO.TEHAI_TANTO_KANA = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.TEHAI_TANTO_EMAIL.ToUpper Then TBL_KAIJO.TEHAI_TANTO_EMAIL = CmnDb.DbData(RsData.GetName(wCnt), RsData)
            ...
            If RsData.GetName(wCnt).ToUpper = TableDef.TBL_KAIJO.Column.DAIKIBO_FLG.ToUpper Then TBL_KAIJO.DAIKIBO_FLG = CmnDb.DbData(RsData.GetName(wCnt), RsData)

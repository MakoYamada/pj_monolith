...
Public Class SQL
    ...
    Public Class TBL_KAIJO
        ...
        Public Shared Function Update(ByVal TBL_KAIJO As TableDef.TBL_KAIJO.DataStruct) As String
            ...
            strSQL &= "," & TableDef.TBL_KAIJO.Column.ANS_TOTAL_TF & "='" & CmnDb.SqlString(TBL_KAIJO.ANS_TOTAL_TF) & "'"
            ...
            strSQL &= "," & TableDef.TBL_KAIJO.Column.ANS_TOTAL_T & "='" & CmnDb.SqlString(TBL_KAIJO.ANS_TOTAL_T) & "'"

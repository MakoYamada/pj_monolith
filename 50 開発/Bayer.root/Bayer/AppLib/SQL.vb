...
Public Class SQL
    ...
    Public Class TBL_KOUENKAI
        ...
        Public Shared Function TaxiPrintCsv() As String
            ...
            'WHERE
            '交通宿泊手配テーブル
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " AND ("
            'QQQ strSQL_WHERE_KOTSUHOTEL &= "    ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_1,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_1,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_1,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_1,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_2,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_2,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_2,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_2,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_3,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_3,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_3,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_3,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_4,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_4,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_4,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_4,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_5,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_5,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_5,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_5,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_6,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_6,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_6,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_6,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_7,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_7,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_7,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_7,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_8,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_8,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_8,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_8,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_9,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_9,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_9,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_9,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_10,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_10,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_10,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_10,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_11,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_11,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_11,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_11,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_12,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_12,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_12,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_12,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_13,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_13,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_13,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_13,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_14,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_14,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_14,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_14,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_15,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_15,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_15,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_15,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_16,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_16,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_16,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_16,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_17,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_17,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_17,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_17,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_18,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_18,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_18,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_18,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_19,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_19,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_19,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_19,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_20,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_20,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_20,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_20,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= ")"

            'QQQ
            strSQL_WHERE_KOTSUHOTEL &= " WHERE ("
            strSQL_WHERE_KOTSUHOTEL &= "    ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_1,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_1,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_2,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_2,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_3,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_3,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_4,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_4,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_5,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_5,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_6,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_6,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_7,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_7,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_8,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_8,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_9,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_9,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_10,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_10,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_11,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_11,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_12,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_12,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_13,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_13,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_14,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_14,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_15,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_15,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_16,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_16,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_17,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_17,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_18,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_18,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_19,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_19,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_20,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_20,N'')<>N''"
    ...
    Public Class TBL_KOTSUHOTEL
        ...
        Public Shared Function TaxiPrintCsv(ByVal KOUENKAI_NO As String) As String
            ...
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " AND("
            'QQQ strSQL_WHERE_KOTSUHOTEL &= "    ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_1,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_1,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_1,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_1,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_1,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_2,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_2,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_2,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_2,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_2,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_3,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_3,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_3,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_3,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_3,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_4,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_4,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_4,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_4,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_4,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_5,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_5,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_5,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_5,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_5,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_6,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_6,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_6,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_6,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_6,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_7,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_7,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_7,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_7,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_7,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_8,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_8,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_8,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_8,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_8,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_9,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_9,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_9,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_9,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_9,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_10,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_10,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_10,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_10,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_10,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_11,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_11,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_11,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_11,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_11,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_12,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_12,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_12,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_12,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_12,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_13,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_13,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_13,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_13,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_13,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_14,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_14,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_14,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_14,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_14,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_15,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_15,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_15,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_15,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_15,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_16,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_16,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_16,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_16,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_16,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_17,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_17,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_17,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_17,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_17,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_18,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_18,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_18,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_18,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_18,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_19,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_19,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_19,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_19,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_19,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_20,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_20,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_HAKKO_DATE_20,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_20,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_20,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= ")"

            'QQQ
            strSQL_WHERE_KOTSUHOTEL &= " AND ("
            strSQL_WHERE_KOTSUHOTEL &= "    ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_1,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_1,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_1,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_2,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_2,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_2,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_3,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_3,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_3,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_4,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_4,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_4,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_5,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_5,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_5,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_6,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_6,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_6,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_7,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_7,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_7,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_8,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_8,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_8,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_9,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_9,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_9,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_10,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_10,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_10,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_11,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_11,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_11,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_12,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_12,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_12,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_13,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_13,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_13,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_14,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_14,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_14,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_15,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_15,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_15,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_16,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_16,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_16,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_17,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_17,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_17,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_18,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_18,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_18,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_19,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_19,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_19,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_20,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_NO_20,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_20,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= ")"
            'QQQ
        ...
        Public Shared Function Update_ANS_TAXI_HAKKO_DATE(ByVal TKT_LINE_NO As String, ByVal TBL_KOTSUHOTEL As TableDef.TBL_KOTSUHOTEL.DataStruct) As String
            ...
            'QQQ Select Case CmnModule.DbVal(TKT_LINE_NO)
            'QQQ Case 1
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_1 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_1) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_1 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_1) & "'"
            'QQQ Case 2
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_2 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_2) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_2 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_2) & "'"
            'QQQ Case 3
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_3 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_3) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_3 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_3) & "'"
            'QQQ Case 4
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_4 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_4) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_4 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_4) & "'"
            'QQQ Case 5
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_5 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_5) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_5 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_5) & "'"
            'QQQ Case 6
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_6 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_6) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_6 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_6) & "'"
            'QQQ Case 7
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_7 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_7) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_7 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_7) & "'"
            'QQQ Case 8
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_8 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_8) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_8 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_8) & "'"
            'QQQ Case 9
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_9 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_9) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_9 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_9) & "'"
            'QQQ Case 10
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_10 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_10) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_10 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_10) & "'"
            'QQQ Case 11
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_11 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_11) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_11 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_11) & "'"
            'QQQ Case 12
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_12 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_12) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_12 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_12) & "'"
            'QQQ Case 13
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_13 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_13) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_13 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_13) & "'"
            'QQQ Case 14
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_14 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_14) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_14 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_14) & "'"
            'QQQ Case 15
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_15 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_15) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_15 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_15) & "'"
            'QQQ Case 16
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_16 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_16) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_16 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_16) & "'"
            'QQQ Case 17
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_17 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_17) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_17 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_17) & "'"
            'QQQ Case 18
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_18 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_18) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_18 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_18) & "'"
            'QQQ Case 19
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_19 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_19) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_19 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_19) & "'"
            'QQQ Case 20
            'QQQ strSQL &= " " & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_20 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_NO_20) & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_HAKKO_DATE_20 & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_20) & "'"
            'QQQ End Select
    ...
    Public Class TBL_TAXITICKET_HAKKO
        ...
        Public Shared Function Search(ByVal Joken As TableDef.Joken.DataStruct, Optional ByVal Miketsu As Boolean = False) As String
            ...
            strSQL &= ",TBL_KOUENKAI." & TableDef.TBL_KOUENKAI.Column.KOUENKAI_NAME
            strSQL &= ",TBL_KOUENKAI." & TableDef.TBL_KOUENKAI.Column.FROM_DATE
            strSQL &= ",TBL_KOUENKAI." & TableDef.TBL_KOUENKAI.Column.TO_DATE
            strSQL &= ",TBL_KOUENKAI." & TableDef.TBL_KOUENKAI.Column.TAXI_PRT_NAME
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_MPID
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_CD
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_NAME
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_KANA
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_SHISETSU_CD
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_SHISETSU_NAME
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_SHISETSU_ADDRESS
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_YAKUWARI
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_SEX
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_AGE
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.SHITEIGAI_RIYU
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.DR_SANKA
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_1
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_1
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_1
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_1
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_1
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_1
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_2
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_2
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_2
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_2
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_2
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_2
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_3
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_3
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_3
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_3
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_3
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_3
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_4
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_4
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_4
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_4
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_4
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_4
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_5
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_5
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_5
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_5
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_5
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_5
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_6
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_6
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_6
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_6
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_6
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_6
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_7
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_7
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_7
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_7
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_7
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_7
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_8
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_8
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_8
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_8
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_8
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_8
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_9
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_9
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_9
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_9
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_9
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_9
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_10
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_10
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_10
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_10
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_10
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_10
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_11
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_11
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_11
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_11
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_11
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_11
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_12
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_12
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_12
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_12
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_12
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_12
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_13
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_13
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_13
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_13
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_13
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_13
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_14
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_14
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_14
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_14
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_14
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_14
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_15
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_15
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_15
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_15
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_15
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_15
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_16
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_16
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_16
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_16
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_16
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_16
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_17
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_17
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_17
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_17
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_17
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_17
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_18
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_18
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_18
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_18
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_18
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_18
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_19
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_19
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_19
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_19
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_19
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_19
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_DATE_20
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_KENSHU_20
            strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ANS_TAXI_NO_20
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_20
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_hakko_Date_20
            'strSQL &= ",TBL_KOTSUHOTEL." & TableDef.TBL_KOTSUHOTEL.Column.ans_taxi_rmks_20
            strSQL &= " , USER_NAME"
            strSQL &= " FROM"
            strSQL &= " TBL_KOTSUHOTEL AS WK_KOTSUHOTEL"
            strSQL &= " , TBL_KOUENKAI AS WK_KOUENKAI"

...
Public Class SQL
    ...
    Public Class TBL_KOUENKAI
        ...
        Public Shared Function TaxiCsv() As String
            Dim strSQL As String = ""
            ...
            'QQQ strSQL_WHERE_KOTSUHOTEL &= "    ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_1,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_1,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_1,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_1,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_2,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_2,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_2,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_2,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_3,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_3,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_3,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_3,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_4,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_4,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_4,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_4,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_5,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_5,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_5,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_5,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_6,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_6,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_6,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_6,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_7,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_7,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_7,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_7,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_8,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_8,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_8,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_8,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_9,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_9,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_9,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_9,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_10,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_10,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_10,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_10,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_11,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_11,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_11,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_11,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_12,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_12,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_12,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_12,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_13,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_13,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_13,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_13,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_14,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_14,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_14,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_14,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_15,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_15,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_15,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_15,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_16,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_16,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_16,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_16,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_17,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_17,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_17,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_17,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_18,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_18,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_18,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_18,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_19,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_19,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_19,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_19,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_20,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_20,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_20,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_20,N'')<>N''"
    ...
    Public Class TBL_KOTSUHOTEL
        ...
        Public Shared Function TaxiCsv(ByVal KOUENKAI_NO As String) As String
            Dim strSQL As String = ""
            Dim strSQL_WHERE_KOTSUHOTEL As String = ""
            Dim strSQL_WHERE_KOUENKAI As String = ""
            ...
            '交通宿泊手配テーブル
            strSQL_WHERE_KOTSUHOTEL &= " WHERE 1=1"
            strSQL_WHERE_KOTSUHOTEL &= " AND TBL_KOTSUHOTEL.KOUENKAI_NO='" & KOUENKAI_NO & "'"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " AND("
            'QQQ strSQL_WHERE_KOTSUHOTEL &= "    ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_1,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_1,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_1,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_1,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_2,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_2,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_2,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_2,N'')<>N''"
            'QQQ strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_3,N'')=N'1' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_HAKKO_DATE_3,N'')=N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_DATE_3,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL.ANS_TAXI_KENSHU_3,N'')<>N''"
        ...
        Public Shared Function Update_ANS_TAXI_HAKKO_DATE(ByVal TBL_KOTSUHOTEL As TableDef.TBL_KOTSUHOTEL.DataStruct) As String
            Dim strSQL As String = ""

            'QQQ strSQL = "UPDATE TBL_KOTSUHOTEL SET"
            ...
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.UPDATE_DATE & "=N'" & GetValue.DATE() & "'"
            'QQQ strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.UPDATE_USER & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.UPDATE_USER) & "'"
            'QQQ strSQL &= " WHERE " & TableDef.TBL_KOTSUHOTEL.Column.SALEFORCE_ID & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.SALEFORCE_ID) & "'"
            'QQQ strSQL &= " AND " & TableDef.TBL_KOTSUHOTEL.Column.SANKASHA_ID & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.SANKASHA_ID) & "'"
            'QQQ strSQL &= " AND " & TableDef.TBL_KOTSUHOTEL.Column.KOUENKAI_NO & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.KOUENKAI_NO) & "'"
            'QQQ strSQL &= " AND " & TableDef.TBL_KOTSUHOTEL.Column.TIME_STAMP_BYL & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.TIME_STAMP_BYL) & "'"
            'QQQ strSQL &= " AND " & TableDef.TBL_KOTSUHOTEL.Column.DR_MPID & "=N'" & CmnDb.SqlString(TBL_KOTSUHOTEL.DR_MPID) & "'"

...
Public Class SQL
    ...
    Public Class TBL_KOUENKAI
        ...
        Public Shared Function Update(ByVal TBL_KOUENKAI As TableDef.TBL_KOUENKAI.DataStruct) As String
            ...
            strSQL &= "," & TableDef.TBL_KOUENKAI.Column.UPDATE_DATE & "='" & GetValue.DATE() & "'"
            strSQL &= "," & TableDef.TBL_KOUENKAI.Column.UPDATE_USER & "='" & GetValue.USER() & "'"
    ...
    Public Class TBL_SEIKYU
        ...
        Public Shared Function Update(ByVal TBL_SEIKYU As TableDef.TBL_SEIKYU.DataStruct) As String
            ...
            strSQL &= "," & TableDef.TBL_SEIKYU.Column.UPDATE_DATE & "='" & GetValue.DATE() & "'"
            strSQL &= "," & TableDef.TBL_SEIKYU.Column.UPDATE_USER & "='" & GetValue.USER() & "'"
    ...
    Public Class TBL_KOTSUHOTEL
        ...
        Public Shared Function Update(ByVal TBL_KOTSUHOTEL As TableDef.TBL_KOTSUHOTEL.DataStruct) As String
            ...
            strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.UPDATE_DATE & "='" & GetValue.DATE() & "'"
            strSQL &= "," & TableDef.TBL_KOTSUHOTEL.Column.UPDATE_USER & "='" & GetValue.USER() & "'"
    ...
    Public Class TBL_KAIJO
        ...
        Public Shared Function Search(ByVal Joken As TableDef.Joken.DataStruct, ByVal NewData As Boolean) As String
            ...
            If Trim(Joken.KIKAKU_TANTO_ROMA) <> "" Then
                strSQL &= " AND ("
                strSQL &= "      TBL_KOUENKAI.KIKAKU_TANTO LIKE '%" & CmnDb.SqlString(Joken.KIKAKU_TANTO_ROMA) & "%'"
                strSQL &= "      OR "
            ...
            If Trim(Joken.TEHAI_TANTO_ROMA) <> "" Then
                strSQL &= " AND ("
                strSQL &= "      TBL_KAIJO.TEHAI_TANTO LIKE '%" & CmnDb.SqlString(Joken.TEHAI_TANTO_ROMA) & "%'"
                strSQL &= "      OR "
                strSQL &= "      TBL_KAIJO.TEHAI_TANTO_ROMA LIKE '%" & CmnDb.SqlString(Joken.TEHAI_TANTO_ROMA) & "%'"
                strSQL &= ")"
            End If
        ...
        Public Shared Function Update(ByVal TBL_KAIJO As TableDef.TBL_KAIJO.DataStruct) As String
            ...
            strSQL &= "," & TableDef.TBL_KAIJO.Column.UPDATE_DATE & "='" & GetValue.DATE() & "'"
            strSQL &= "," & TableDef.TBL_KAIJO.Column.UPDATE_USER & "='" & GetValue.USER() & "'"
    ...
    Public Class MS_SHISETSU
        ...
        Public Shared Function Update(ByVal MS_SHISETSU As TableDef.MS_SHISETSU.DataStruct) As String
            ...
            strSQL &= "," & TableDef.MS_SHISETSU.Column.UPDATE_DATE & "='" & GetValue.DATE() & "'"
            strSQL &= "," & TableDef.MS_SHISETSU.Column.UPDATE_USER & "='" & GetValue.USER() & "'"
    ...
    Public Class MS_USER
        ...
        Public Shared Function Update(ByVal MS_USER As TableDef.MS_USER.DataStruct) As String
            ...
            strSQL &= "," & TableDef.MS_USER.Column.UPDATE_DATE & "='" & GetValue.DATE() & "'"
            strSQL &= "," & TableDef.MS_USER.Column.UPDATE_USER & "='" & GetValue.USER() & "'"
    ...
    Public Class MS_JIGYOSHO
        ...
        Public Shared Function Update(ByVal MS_JIGYOSHO As TableDef.MS_JIGYOSHO.DataStruct) As String
            ...
            strSQL &= "," & TableDef.MS_JIGYOSHO.Column.UPDATE_DATE & "='" & GetValue.DATE() & "'"
            strSQL &= "," & TableDef.MS_JIGYOSHO.Column.UPDATE_USER & "='" & GetValue.USER() & "'"
    ...
    Public Class MS_AREA
        ...
        Public Shared Function Update(ByVal MS_AREA As TableDef.MS_AREA.DataStruct) As String
            ...
            strSQL &= "," & TableDef.MS_AREA.Column.UPDATE_DATE & "='" & GetValue.DATE() & "'"
            strSQL &= "," & TableDef.MS_AREA.Column.UPDATE_USER & "='" & GetValue.USER() & "'"
    ...
    Public Class MS_EIGYOSHO
        ...
        Public Shared Function Update(ByVal MS_EIGYOSHO As TableDef.MS_EIGYOSHO.DataStruct) As String
            ...
            strSQL &= "," & TableDef.MS_EIGYOSHO.Column.UPDATE_DATE & "='" & GetValue.DATE() & "'"
            strSQL &= "," & TableDef.MS_EIGYOSHO.Column.UPDATE_USER & "='" & GetValue.USER() & "'"

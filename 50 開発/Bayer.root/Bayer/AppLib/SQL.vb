...
Public Class SQL
    ...
    Public Class TBL_KOUENKAI
        ...
        Public Shared Function TaxiCsv() As String
            ...
            strSQL_WHERE_KOTSUHOTEL &= "    ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_1,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_1,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_2,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_2,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_3,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_3,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_4,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_4,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_5,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_5,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_6,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_6,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_7,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_7,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_8,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_8,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_9,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_9,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_10,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_10,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_11,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_11,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_12,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_12,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_13,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_13,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_14,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_14,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_15,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_15,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_16,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_16,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_17,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_17,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_18,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_18,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_19,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_19,N'')<>N''"
            strSQL_WHERE_KOTSUHOTEL &= " OR ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_DATE_20,N'')<>N'' AND ISNULL(TBL_KOTSUHOTEL_1.ANS_TAXI_KENSHU_20,N'')<>N''"

        ...
        <tr>
            <td>
                <table width="1000px">
                    ...
                    <tr align="left">
                        <td>
                            <table cellspacing="0" cellpadding="2" border="0" id="TblButton1" runat="server">
					            <tr align="center">
					                <td>
                                        <asp:Button ID="BtnSeisanListPrint1" runat="server" Text="ê∏éZÉfÅ[É^àÍóóàÛç¸" Width="130px" CssClass="Button" />
                                        <asp:Button ID="BtnMishuHoukoku1" runat="server" Text="ñ¢é˚ì¸ã‡ëÿóØóùóRïÒçêèëàÛç¸" Width="200px" CssClass="Button" />
                        ...
                        <td>
                            <asp:GridView ID="GrvList" runat="server" TabIndex="15" CellPadding="2" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="KIKAKU_TANTO_AREA" HeaderText="ÉGÉäÉA" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HtmlEncode="False">
                                        <HeaderStyle Wrap="False"></HeaderStyle>
                                        <ItemStyle Wrap="False" Width="70px" HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="KIKAKU_TANTO_EIGYOSHO" HeaderText="âcã∆èä" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HtmlEncode="False">
                                        <HeaderStyle Wrap="False"></HeaderStyle>
                                        <ItemStyle Wrap="False" Width="80px" HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="KIKAKU_TANTO_NAME" HeaderText="äÈâÊíSìñé“" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HtmlEncode="False">
                                        <HeaderStyle Wrap="False"></HeaderStyle>
                                    ...
                                    <asp:BoundField DataField="TEHAI_ID" HeaderText="âÔèÍéËîzî‘çÜ" >
                                        <ItemStyle HorizontalAlign="Left" Width="130px" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="SEISAN_YM" HeaderText="TOP<br/>ê∏éZîNåé" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HtmlEncode="False">
                                        <HeaderStyle Wrap="False"></HeaderStyle>
                                    ...
                                    <asp:BoundField DataField="SEND_FLAG" HeaderText="NOZOMI<br/>ëóêM" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HtmlEncode="False">
                                        <HeaderStyle Wrap="False"></HeaderStyle>
                    ...
                    <tr align="left">
                        <td>
                            <asp:Button ID="BtnSeisanListPrint2" runat="server" Text="ê∏éZÉfÅ[É^àÍóóàÛç¸" Width="130px" CssClass="Button" />
                            <asp:Button ID="BtnMishuHoukoku2" runat="server" Text="ñ¢é˚ì¸ã‡ëÿóØóùóRïÒçêèëàÛç¸" Width="200px" CssClass="Button" />

        ...
        <tr>
            <td>
                <table width="1000px">
                        ...
                        <td>
                            <asp:GridView ID="GrvList" runat="server" TabIndex="15" CellPadding="2" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SEIKYU_NO_TOPTOUR" HeaderText="TOPêøãÅèëî‘çÜ" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                        <HeaderStyle Wrap="False"></HeaderStyle>
                                        <ItemStyle Wrap="False" Width="130px" HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SEISAN_YM" HeaderText="ê∏éZîNåé" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                        <HeaderStyle Wrap="False"></HeaderStyle>
                    ...
                    <tr align="center">
                        <td>
                            <asp:Button ID="BtnBack" runat="server" Text="ñﬂÇÈ" Width="130px" 
                                CssClass="Button" />
                        </td>
                    </tr>
                </table>

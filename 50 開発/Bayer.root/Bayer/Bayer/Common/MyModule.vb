    ...
    Public Class Csv
        Public Shared Function DrCsv(ByVal CsvData() As TableDef.TBL_KOTSUHOTEL.DataStruct, _
            ...
            For wCnt = 0 To UBound(CsvData)
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).HOTEL_IRAINAIYOU)))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_HOTEL_DATE(CsvData(wCnt).REQ_HOTEL_DATE))))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_HOTEL_DATE(CsvData(wCnt).ANS_HOTEL_DATE))))

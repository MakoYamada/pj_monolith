...
Public Class MyModule
    ...
    Public Class Csv
        Public Shared Function TaxiCsv(ByVal CsvData() As TableDef.TBL_KOTSUHOTEL.DataStruct) As String
            ...
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("手配スタータス(依頼)")))
            ...
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("性別(航空券の場合必須)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("航空搭乗者年齢(年齢)(航空券の場合必須)")))
            ...
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程1:利用日(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程1:発地(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程1:依頼金額(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程2:利用日(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程2:発地(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程2:依頼金額(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程3:利用日(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程3:発地(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程3:依頼金額(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程4:利用日(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程4:発地(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程4:依頼金額(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程5:利用日(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程5:発地(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程5:依頼金額(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程6:利用日(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程6:発地(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程6:依頼金額(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程7:利用日(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程7:発地(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程7:依頼金額(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程8:利用日(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程8:発地(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程8:依頼金額(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程9:利用日(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程9:発地(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程9:依頼金額(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程10:利用日(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程10:発地(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("行程10:依頼金額(依頼)")))
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes("タクチケ備考(依頼)")))
            sb.Append(vbNewLine)

            For wCnt = 0 To UBound(CsvData)
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_KOUENKAI_NO(CsvData(wCnt).KOUENKAI_NO))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TORIKESHI_FLG(CsvData(wCnt).TORIKESHI_FLG))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_KOUENKAI_NAME(CsvData(wCnt).KOUENKAI_NAME))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_PRT_NAME(CsvData(wCnt).TAXI_PRT_NAME))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_FROM_DATE(CsvData(wCnt).FROM_DATE))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TO_DATE(CsvData(wCnt).TO_DATE))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_KAIJO_NAME(CsvData(wCnt).KAIJO_NAME))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_SEIHIN_NAME(CsvData(wCnt).SEIHIN_NAME))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_SALEFORCE_ID(CsvData(wCnt).SALEFORCE_ID))))
                ...
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_DR_MPID(CsvData(wCnt).DR_MPID))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_DR_CD(CsvData(wCnt).DR_CD))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_DR_NAME(CsvData(wCnt).DR_NAME))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_DR_KANA(CsvData(wCnt).DR_KANA))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_DR_SHISETSU_CD(CsvData(wCnt).DR_SHISETSU_CD))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_DR_SHISETSU_NAME(CsvData(wCnt).DR_SHISETSU_NAME))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_DR_SHISETSU_ADDRESS(CsvData(wCnt).DR_SHISETSU_ADDRESS))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_DR_YAKUWARI(CsvData(wCnt).DR_YAKUWARI))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_DR_SEX(CsvData(wCnt).DR_SEX))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_DR_AGE(CsvData(wCnt).DR_AGE))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_SHITEIGAI_RIYU(CsvData(wCnt).SHITEIGAI_RIYU))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_BU(CsvData(wCnt).MR_BU))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_AREA(CsvData(wCnt).MR_AREA))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_EIGYOSHO(CsvData(wCnt).MR_EIGYOSHO))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_NAME(CsvData(wCnt).MR_NAME))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_ROMA(CsvData(wCnt).MR_ROMA))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_KANA(CsvData(wCnt).MR_KANA))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_EMAIL_PC(CsvData(wCnt).MR_EMAIL_PC))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_EMAIL_KEITAI(CsvData(wCnt).MR_EMAIL_KEITAI))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_KEITAI(CsvData(wCnt).MR_KEITAI))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_TEL(CsvData(wCnt).MR_TEL))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_SEND_SAKI_FS(CsvData(wCnt).MR_SEND_SAKI_FS))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_MR_SEND_SAKI_OTHER(CsvData(wCnt).MR_SEND_SAKI_OTHER))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_SHONIN_NAME(CsvData(wCnt).SHONIN_NAME))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_SHONIN_DATE(CsvData(wCnt).SHONIN_DATE))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TEHAI_TAXI(CsvData(wCnt).TEHAI_TAXI))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_DATE_1(CsvData(wCnt).REQ_TAXI_DATE_1))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_FROM_1(CsvData(wCnt).REQ_TAXI_FROM_1))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_YOTEIKINGAKU_1(CsvData(wCnt).TAXI_YOTEIKINGAKU_1))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_DATE_2(CsvData(wCnt).REQ_TAXI_DATE_2))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_FROM_2(CsvData(wCnt).REQ_TAXI_FROM_2))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_YOTEIKINGAKU_2(CsvData(wCnt).TAXI_YOTEIKINGAKU_2))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_DATE_3(CsvData(wCnt).REQ_TAXI_DATE_3))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_FROM_3(CsvData(wCnt).REQ_TAXI_FROM_3))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_YOTEIKINGAKU_3(CsvData(wCnt).TAXI_YOTEIKINGAKU_3))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_DATE_4(CsvData(wCnt).REQ_TAXI_DATE_4))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_FROM_4(CsvData(wCnt).REQ_TAXI_FROM_4))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_YOTEIKINGAKU_4(CsvData(wCnt).TAXI_YOTEIKINGAKU_4))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_DATE_5(CsvData(wCnt).REQ_TAXI_DATE_5))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_FROM_5(CsvData(wCnt).REQ_TAXI_FROM_5))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_YOTEIKINGAKU_5(CsvData(wCnt).TAXI_YOTEIKINGAKU_5))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_DATE_6(CsvData(wCnt).REQ_TAXI_DATE_6))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_FROM_6(CsvData(wCnt).REQ_TAXI_FROM_6))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_YOTEIKINGAKU_6(CsvData(wCnt).TAXI_YOTEIKINGAKU_6))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_DATE_7(CsvData(wCnt).REQ_TAXI_DATE_7))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_FROM_7(CsvData(wCnt).REQ_TAXI_FROM_7))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_YOTEIKINGAKU_7(CsvData(wCnt).TAXI_YOTEIKINGAKU_7))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_DATE_8(CsvData(wCnt).REQ_TAXI_DATE_8))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_FROM_8(CsvData(wCnt).REQ_TAXI_FROM_8))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_YOTEIKINGAKU_8(CsvData(wCnt).TAXI_YOTEIKINGAKU_8))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_DATE_9(CsvData(wCnt).REQ_TAXI_DATE_9))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_FROM_9(CsvData(wCnt).REQ_TAXI_FROM_9))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_YOTEIKINGAKU_9(CsvData(wCnt).TAXI_YOTEIKINGAKU_9))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_DATE_10(CsvData(wCnt).REQ_TAXI_DATE_10))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_FROM_10(CsvData(wCnt).REQ_TAXI_FROM_10))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_TAXI_YOTEIKINGAKU_10(CsvData(wCnt).TAXI_YOTEIKINGAKU_10))))
                sb.Append(CmnCsv.SetData(CmnCsv.Quotes(AppModule.GetName_REQ_TAXI_NOTE(CsvData(wCnt).REQ_TAXI_NOTE))))
                sb.Append(vbNewLine)
            Next wCnt

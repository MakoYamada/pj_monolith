...
Partial Public Class KouenkaiRegist
    ...
    Private Sub SetForm()
        ...
        Me.KOUENKAI_TITLE.Text = AppModule.GetName_KOUENKAI_TITLE(DSP_KOUENKAI(DSP_SEQ).KOUENKAI_TITLE)
        ...
        Me.SANKA_YOTEI_CNT.Text = AppModule.GetName_SANKA_YOTEI_CNT(DSP_KOUENKAI(DSP_SEQ).SANKA_YOTEI_CNT)

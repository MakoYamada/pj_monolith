...
Public Class DrReport1 
    ...
    Private Sub Detail_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail.Format
        ...
        REQ_O_IRAINAIYOU_1.Text = AppModule.GetName_REQ_O_IRAINAIYOU(REQ_O_IRAINAIYOU_1.Text)
        ...
        REQ_F_IRAINAIYOU_1.Text = AppModule.GetName_REQ_F_IRAINAIYOU(REQ_F_IRAINAIYOU_1.Text)

...
Partial Public Class DrRegist
    ...
    Private Sub SetForm()
        ...
        AppModule.SetForm_ANS_TAXI_MAISUU(DSP_KOTSUHOTEL(SEQ).ANS_TAXI_TESURYO, Me.ANS_TAXI_MAISUU, DSP_KOTSUHOTEL(SEQ).FROM_DATE, MyBase.DbConnection)
        ...
        If Not Popup Then
            SetChangedColor(Me.TAXI_PRT_NAME, DSP_KOTSUHOTEL(DSP_SEQ).TAXI_PRT_NAME, OldTBL_KOTSUHOTEL.TAXI_PRT_NAME)
    ...
    Private Sub GetValue(ByVal SEND_FLAG As String)
        ...
        DSP_KOTSUHOTEL(SEQ).ANS_KOTSUHOTEL_TESURYO = AppModule.GetValue_ANS_KOTSUHOTEL_TESURYO(Me.CHK_KOTSUHOTEL_TESURYO, DSP_KOTSUHOTEL(SEQ).FROM_DATE, MyBase.DbConnection)
        DSP_KOTSUHOTEL(SEQ).ANS_TAXI_TESURYO = AppModule.GetValue_ANS_TAXI_TESURYO(Me.ANS_TAXI_MAISUU, DSP_KOTSUHOTEL(SEQ).FROM_DATE, MyBase.DbConnection)

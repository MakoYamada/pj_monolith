...
Partial Public Class DrRegist
    ...
    Private Sub SetForm()
        ...
        If Not Popup Then
            Me.MR_BU.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_BU, OldTBL_KOTSUHOTEL.MR_BU)
            Me.MR_AREA.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_AREA, OldTBL_KOTSUHOTEL.MR_AREA)
            Me.MR_EIGYOSHO.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_EIGYOSHO, OldTBL_KOTSUHOTEL.MR_EIGYOSHO)
            Me.ACCOUNT_CODE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ACCOUNT_CD, OldTBL_KOTSUHOTEL.ACCOUNT_CD)
            Me.COST_CENTER.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).COST_CENTER, OldTBL_KOTSUHOTEL.COST_CENTER)
            Me.INTERNAL_ORDER.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).INTERNAL_ORDER, OldTBL_KOTSUHOTEL.INTERNAL_ORDER)
            Me.ZETIA_CD.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ZETIA_CD, OldTBL_KOTSUHOTEL.ZETIA_CD)
            Me.MR_NAME.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_NAME, OldTBL_KOTSUHOTEL.MR_NAME)
            Me.MR_ROMA.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_ROMA, OldTBL_KOTSUHOTEL.MR_ROMA)
            Me.MR_KEITAI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_KEITAI, OldTBL_KOTSUHOTEL.MR_KEITAI)
            Me.MR_TEL.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_TEL, OldTBL_KOTSUHOTEL.MR_TEL)
            Me.MR_EMAIL_KEITAI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_EMAIL_KEITAI, OldTBL_KOTSUHOTEL.MR_EMAIL_KEITAI)
            Me.MR_EMAIL_PC.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_EMAIL_PC, OldTBL_KOTSUHOTEL.MR_EMAIL_PC)
            Me.MR_SEND_SAKI_FS.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_SEND_SAKI_FS, OldTBL_KOTSUHOTEL.MR_SEND_SAKI_FS)
            Me.MR_SEND_SAKI_OTHER.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_SEND_SAKI_OTHER, OldTBL_KOTSUHOTEL.MR_SEND_SAKI_OTHER)
            Me.REQ_STATUS_TEHAI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_STATUS_TEHAI, OldTBL_KOTSUHOTEL.REQ_STATUS_TEHAI)
            Me.ANS_STATUS_TEHAI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_STATUS_TEHAI, OldTBL_KOTSUHOTEL.ANS_STATUS_TEHAI)
            Me.ANS_TICKET_SEND_DAY.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TICKET_SEND_DAY, OldTBL_KOTSUHOTEL.ANS_TICKET_SEND_DAY)
            Me.SEND_FLAG.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).SEND_FLAG, OldTBL_KOTSUHOTEL.SEND_FLAG)
            Me.TIME_STAMP_BYL.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TIME_STAMP_BYL, OldTBL_KOTSUHOTEL.TIME_STAMP_BYL)
            Me.TIME_STAMP_TOP.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TIME_STAMP_TOP, OldTBL_KOTSUHOTEL.TIME_STAMP_TOP)
            Me.DR_NAME.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).DR_NAME, OldTBL_KOTSUHOTEL.DR_NAME)
            Me.DR_KANA.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).DR_KANA, OldTBL_KOTSUHOTEL.DR_KANA)
            Me.DR_SEX.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).DR_SEX, OldTBL_KOTSUHOTEL.DR_SEX)
            Me.DR_AGE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).DR_AGE, OldTBL_KOTSUHOTEL.DR_AGE)
            Me.DR_SANKA.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).DR_SANKA, OldTBL_KOTSUHOTEL.DR_SANKA)
            Me.DR_YAKUWARI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).DR_YAKUWARI, OldTBL_KOTSUHOTEL.DR_YAKUWARI)
            Me.DR_SHISETSU_CD.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).DR_SHISETSU_CD, OldTBL_KOTSUHOTEL.DR_SHISETSU_CD)
            Me.DR_SHISETSU_NAME.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).DR_SHISETSU_NAME, OldTBL_KOTSUHOTEL.DR_SHISETSU_NAME)
            Me.DR_SHISETSU_ADDRESS.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).DR_SHISETSU_ADDRESS, OldTBL_KOTSUHOTEL.DR_SHISETSU_ADDRESS)
            Me.SHITEIGAI_RIYU.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).SHITEIGAI_RIYU, OldTBL_KOTSUHOTEL.SHITEIGAI_RIYU)
            Me.SHONIN_NAME.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).SHONIN_NAME, OldTBL_KOTSUHOTEL.SHONIN_NAME)
            Me.SHONIN_DATE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).SHONIN_DATE, OldTBL_KOTSUHOTEL.SHONIN_DATE)
            Me.TEHAI_HOTEL.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TEHAI_HOTEL, OldTBL_KOTSUHOTEL.TEHAI_HOTEL)
            Me.HOTEL_IRAINAIYOU.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).HOTEL_IRAINAIYOU, OldTBL_KOTSUHOTEL.HOTEL_IRAINAIYOU)
            Me.REQ_HOTEL_DATE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_HOTEL_DATE, OldTBL_KOTSUHOTEL.REQ_HOTEL_DATE)
            Me.REQ_HAKUSU.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_HAKUSU, OldTBL_KOTSUHOTEL.REQ_HAKUSU)
            Me.REQ_HOTEL_SMOKING.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_HOTEL_SMOKING, OldTBL_KOTSUHOTEL.REQ_HOTEL_SMOKING)
            Me.REQ_HOTEL_NOTE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_HOTEL_NOTE, OldTBL_KOTSUHOTEL.REQ_HOTEL_NOTE)
            Me.ANS_STATUS_HOTEL.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_STATUS_HOTEL, OldTBL_KOTSUHOTEL.ANS_STATUS_HOTEL)
            Me.ANS_HOTEL_NAME.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_HOTEL_NAME, OldTBL_KOTSUHOTEL.ANS_HOTEL_NAME)
            Me.ANS_HOTEL_ADDRESS.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_HOTEL_ADDRESS, OldTBL_KOTSUHOTEL.ANS_HOTEL_ADDRESS)
            Me.ANS_HOTEL_TEL.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_HOTEL_TEL, OldTBL_KOTSUHOTEL.ANS_HOTEL_TEL)
            Me.ANS_HOTEL_DATE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_HOTEL_DATE, OldTBL_KOTSUHOTEL.ANS_HOTEL_DATE)
            Me.ANS_HAKUSU.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_HAKUSU, OldTBL_KOTSUHOTEL.ANS_HAKUSU)
            Me.ANS_CHECKIN_TIME.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_CHECKIN_TIME, OldTBL_KOTSUHOTEL.ANS_CHECKIN_TIME)
            Me.ANS_CHECKOUT_TIME.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_CHECKOUT_TIME, OldTBL_KOTSUHOTEL.ANS_CHECKOUT_TIME)
            Me.ANS_ROOM_TYPE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_ROOM_TYPE, OldTBL_KOTSUHOTEL.ANS_ROOM_TYPE)
            Me.ANS_HOTEL_SMOKING.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_HOTEL_SMOKING, OldTBL_KOTSUHOTEL.ANS_HOTEL_SMOKING)
            Me.ANS_HOTEL_NOTE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_HOTEL_NOTE, OldTBL_KOTSUHOTEL.ANS_HOTEL_NOTE)
            Me.REQ_O_TEHAI_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TEHAI_1, OldTBL_KOTSUHOTEL.REQ_O_TEHAI_1)
            Me.REQ_O_IRAINAIYOU_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_IRAINAIYOU_1, OldTBL_KOTSUHOTEL.REQ_O_IRAINAIYOU_1)
            Me.REQ_O_KOTSUKIKAN_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_KOTSUKIKAN_1, OldTBL_KOTSUHOTEL.REQ_O_KOTSUKIKAN_1)
            Me.REQ_O_DATE_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_DATE_1, OldTBL_KOTSUHOTEL.REQ_O_DATE_1)
            Me.REQ_O_AIRPORT1_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_AIRPORT1_1, OldTBL_KOTSUHOTEL.REQ_O_AIRPORT1_1)
            Me.REQ_O_AIRPORT2_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_AIRPORT2_1, OldTBL_KOTSUHOTEL.REQ_O_AIRPORT2_1)
            Me.REQ_O_TIME1_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TIME1_1, OldTBL_KOTSUHOTEL.REQ_O_TIME1_1)
            Me.REQ_O_TIME2_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TIME2_1, OldTBL_KOTSUHOTEL.REQ_O_TIME2_1)
            Me.REQ_O_BIN_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_BIN_1, OldTBL_KOTSUHOTEL.REQ_O_BIN_1)
            Me.REQ_O_SEAT_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_SEAT_1, OldTBL_KOTSUHOTEL.REQ_O_SEAT_1)
            Me.REQ_O_SEAT_KIBOU1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_SEAT_KIBOU1, OldTBL_KOTSUHOTEL.REQ_O_SEAT_KIBOU1)
            Me.REQ_O_TEHAI_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TEHAI_2, OldTBL_KOTSUHOTEL.REQ_O_TEHAI_2)
            Me.REQ_O_IRAINAIYOU_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_IRAINAIYOU_2, OldTBL_KOTSUHOTEL.REQ_O_IRAINAIYOU_2)
            Me.REQ_O_KOTSUKIKAN_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_KOTSUKIKAN_2, OldTBL_KOTSUHOTEL.REQ_O_KOTSUKIKAN_2)
            Me.REQ_O_DATE_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_DATE_2, OldTBL_KOTSUHOTEL.REQ_O_DATE_2)
            Me.REQ_O_AIRPORT1_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_AIRPORT1_2, OldTBL_KOTSUHOTEL.REQ_O_AIRPORT1_2)
            Me.REQ_O_AIRPORT2_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_AIRPORT2_2, OldTBL_KOTSUHOTEL.REQ_O_AIRPORT2_2)
            Me.REQ_O_TIME1_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TIME1_2, OldTBL_KOTSUHOTEL.REQ_O_TIME1_2)
            Me.REQ_O_TIME2_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TIME2_2, OldTBL_KOTSUHOTEL.REQ_O_TIME2_2)
            Me.REQ_O_BIN_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_BIN_2, OldTBL_KOTSUHOTEL.REQ_O_BIN_2)
            Me.REQ_O_SEAT_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_SEAT_2, OldTBL_KOTSUHOTEL.REQ_O_SEAT_2)
            Me.REQ_O_SEAT_KIBOU2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_SEAT_KIBOU2, OldTBL_KOTSUHOTEL.REQ_O_SEAT_KIBOU2)
            Me.REQ_O_TEHAI_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TEHAI_3, OldTBL_KOTSUHOTEL.REQ_O_TEHAI_3)
            Me.REQ_O_IRAINAIYOU_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_IRAINAIYOU_3, OldTBL_KOTSUHOTEL.REQ_O_IRAINAIYOU_3)
            Me.REQ_O_KOTSUKIKAN_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_KOTSUKIKAN_3, OldTBL_KOTSUHOTEL.REQ_O_KOTSUKIKAN_3)
            Me.REQ_O_DATE_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_DATE_3, OldTBL_KOTSUHOTEL.REQ_O_DATE_3)
            Me.REQ_O_AIRPORT1_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_AIRPORT1_3, OldTBL_KOTSUHOTEL.REQ_O_AIRPORT1_3)
            Me.REQ_O_AIRPORT2_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_AIRPORT2_3, OldTBL_KOTSUHOTEL.REQ_O_AIRPORT2_3)
            Me.REQ_O_TIME1_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TIME1_3, OldTBL_KOTSUHOTEL.REQ_O_TIME1_3)
            Me.REQ_O_TIME2_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TIME2_3, OldTBL_KOTSUHOTEL.REQ_O_TIME2_3)
            Me.REQ_O_BIN_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_BIN_3, OldTBL_KOTSUHOTEL.REQ_O_BIN_3)
            Me.REQ_O_SEAT_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_SEAT_3, OldTBL_KOTSUHOTEL.REQ_O_SEAT_3)
            Me.REQ_O_SEAT_KIBOU3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_SEAT_KIBOU3, OldTBL_KOTSUHOTEL.REQ_O_SEAT_KIBOU3)
            Me.REQ_O_TEHAI_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TEHAI_4, OldTBL_KOTSUHOTEL.REQ_O_TEHAI_4)
            Me.REQ_O_IRAINAIYOU_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_IRAINAIYOU_4, OldTBL_KOTSUHOTEL.REQ_O_IRAINAIYOU_4)
            Me.REQ_O_KOTSUKIKAN_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_KOTSUKIKAN_4, OldTBL_KOTSUHOTEL.REQ_O_KOTSUKIKAN_4)
            Me.REQ_O_DATE_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_DATE_4, OldTBL_KOTSUHOTEL.REQ_O_DATE_4)
            Me.REQ_O_AIRPORT1_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_AIRPORT1_4, OldTBL_KOTSUHOTEL.REQ_O_AIRPORT1_4)
            Me.REQ_O_AIRPORT2_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_AIRPORT2_4, OldTBL_KOTSUHOTEL.REQ_O_AIRPORT2_4)
            Me.REQ_O_TIME1_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TIME1_4, OldTBL_KOTSUHOTEL.REQ_O_TIME1_4)
            Me.REQ_O_TIME2_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TIME2_4, OldTBL_KOTSUHOTEL.REQ_O_TIME2_4)
            Me.REQ_O_BIN_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_BIN_4, OldTBL_KOTSUHOTEL.REQ_O_BIN_4)
            Me.REQ_O_SEAT_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_SEAT_4, OldTBL_KOTSUHOTEL.REQ_O_SEAT_4)
            Me.REQ_O_SEAT_KIBOU4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_SEAT_KIBOU4, OldTBL_KOTSUHOTEL.REQ_O_SEAT_KIBOU4)
            Me.REQ_O_TEHAI_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TEHAI_5, OldTBL_KOTSUHOTEL.REQ_O_TEHAI_5)
            Me.REQ_O_IRAINAIYOU_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_IRAINAIYOU_5, OldTBL_KOTSUHOTEL.REQ_O_IRAINAIYOU_5)
            Me.REQ_O_KOTSUKIKAN_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_KOTSUKIKAN_5, OldTBL_KOTSUHOTEL.REQ_O_KOTSUKIKAN_5)
            Me.REQ_O_DATE_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_DATE_5, OldTBL_KOTSUHOTEL.REQ_O_DATE_5)
            Me.REQ_O_AIRPORT1_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_AIRPORT1_5, OldTBL_KOTSUHOTEL.REQ_O_AIRPORT1_5)
            Me.REQ_O_AIRPORT2_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_AIRPORT2_5, OldTBL_KOTSUHOTEL.REQ_O_AIRPORT2_5)
            Me.REQ_O_TIME1_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TIME1_5, OldTBL_KOTSUHOTEL.REQ_O_TIME1_5)
            Me.REQ_O_TIME2_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_TIME2_5, OldTBL_KOTSUHOTEL.REQ_O_TIME2_5)
            Me.REQ_O_BIN_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_BIN_5, OldTBL_KOTSUHOTEL.REQ_O_BIN_5)
            Me.REQ_O_SEAT_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_SEAT_5, OldTBL_KOTSUHOTEL.REQ_O_SEAT_5)
            Me.REQ_O_SEAT_KIBOU5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_O_SEAT_KIBOU5, OldTBL_KOTSUHOTEL.REQ_O_SEAT_KIBOU5)
            Me.REQ_F_TEHAI_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TEHAI_1, OldTBL_KOTSUHOTEL.REQ_F_TEHAI_1)
            Me.REQ_F_IRAINAIYOU_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_IRAINAIYOU_1, OldTBL_KOTSUHOTEL.REQ_F_IRAINAIYOU_1)
            Me.REQ_F_KOTSUKIKAN_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_KOTSUKIKAN_1, OldTBL_KOTSUHOTEL.REQ_F_KOTSUKIKAN_1)
            Me.REQ_F_DATE_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_DATE_1, OldTBL_KOTSUHOTEL.REQ_F_DATE_1)
            Me.REQ_F_AIRPORT1_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_AIRPORT1_1, OldTBL_KOTSUHOTEL.REQ_F_AIRPORT1_1)
            Me.REQ_F_AIRPORT2_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_AIRPORT2_1, OldTBL_KOTSUHOTEL.REQ_F_AIRPORT2_1)
            Me.REQ_F_TIME1_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TIME1_1, OldTBL_KOTSUHOTEL.REQ_F_TIME1_1)
            Me.REQ_F_TIME2_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TIME2_1, OldTBL_KOTSUHOTEL.REQ_F_TIME2_1)
            Me.REQ_F_BIN_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_BIN_1, OldTBL_KOTSUHOTEL.REQ_F_BIN_1)
            Me.REQ_F_SEAT_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_SEAT_1, OldTBL_KOTSUHOTEL.REQ_F_SEAT_1)
            Me.REQ_F_SEAT_KIBOU1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_SEAT_KIBOU1, OldTBL_KOTSUHOTEL.REQ_F_SEAT_KIBOU1)
            Me.REQ_F_TEHAI_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TEHAI_2, OldTBL_KOTSUHOTEL.REQ_F_TEHAI_2)
            Me.REQ_F_IRAINAIYOU_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_IRAINAIYOU_2, OldTBL_KOTSUHOTEL.REQ_F_IRAINAIYOU_2)
            Me.REQ_F_KOTSUKIKAN_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_KOTSUKIKAN_2, OldTBL_KOTSUHOTEL.REQ_F_KOTSUKIKAN_2)
            Me.REQ_F_DATE_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_DATE_2, OldTBL_KOTSUHOTEL.REQ_F_DATE_2)
            Me.REQ_F_AIRPORT1_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_AIRPORT1_2, OldTBL_KOTSUHOTEL.REQ_F_AIRPORT1_2)
            Me.REQ_F_AIRPORT2_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_AIRPORT2_2, OldTBL_KOTSUHOTEL.REQ_F_AIRPORT2_2)
            Me.REQ_F_TIME1_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TIME1_2, OldTBL_KOTSUHOTEL.REQ_F_TIME1_2)
            Me.REQ_F_TIME2_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TIME2_2, OldTBL_KOTSUHOTEL.REQ_F_TIME2_2)
            Me.REQ_F_BIN_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_BIN_2, OldTBL_KOTSUHOTEL.REQ_F_BIN_2)
            Me.REQ_F_SEAT_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_SEAT_2, OldTBL_KOTSUHOTEL.REQ_F_SEAT_2)
            Me.REQ_F_SEAT_KIBOU2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_SEAT_KIBOU2, OldTBL_KOTSUHOTEL.REQ_F_SEAT_KIBOU2)
            Me.REQ_F_TEHAI_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TEHAI_3, OldTBL_KOTSUHOTEL.REQ_F_TEHAI_3)
            Me.REQ_F_IRAINAIYOU_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_IRAINAIYOU_3, OldTBL_KOTSUHOTEL.REQ_F_IRAINAIYOU_3)
            Me.REQ_F_KOTSUKIKAN_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_KOTSUKIKAN_3, OldTBL_KOTSUHOTEL.REQ_F_KOTSUKIKAN_3)
            Me.REQ_F_DATE_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_DATE_3, OldTBL_KOTSUHOTEL.REQ_F_DATE_3)
            Me.REQ_F_AIRPORT1_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_AIRPORT1_3, OldTBL_KOTSUHOTEL.REQ_F_AIRPORT1_3)
            Me.REQ_F_AIRPORT2_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_AIRPORT2_3, OldTBL_KOTSUHOTEL.REQ_F_AIRPORT2_3)
            Me.REQ_F_TIME1_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TIME1_3, OldTBL_KOTSUHOTEL.REQ_F_TIME1_3)
            Me.REQ_F_TIME2_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TIME2_3, OldTBL_KOTSUHOTEL.REQ_F_TIME2_3)
            Me.REQ_F_BIN_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_BIN_3, OldTBL_KOTSUHOTEL.REQ_F_BIN_3)
            Me.REQ_F_SEAT_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_SEAT_3, OldTBL_KOTSUHOTEL.REQ_F_SEAT_3)
            Me.REQ_F_SEAT_KIBOU3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_SEAT_KIBOU3, OldTBL_KOTSUHOTEL.REQ_F_SEAT_KIBOU3)
            Me.REQ_F_TEHAI_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TEHAI_4, OldTBL_KOTSUHOTEL.REQ_F_TEHAI_4)
            Me.REQ_F_IRAINAIYOU_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_IRAINAIYOU_4, OldTBL_KOTSUHOTEL.REQ_F_IRAINAIYOU_4)
            Me.REQ_F_KOTSUKIKAN_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_KOTSUKIKAN_4, OldTBL_KOTSUHOTEL.REQ_F_KOTSUKIKAN_4)
            Me.REQ_F_DATE_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_DATE_4, OldTBL_KOTSUHOTEL.REQ_F_DATE_4)
            Me.REQ_F_AIRPORT1_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_AIRPORT1_4, OldTBL_KOTSUHOTEL.REQ_F_AIRPORT1_4)
            Me.REQ_F_AIRPORT2_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_AIRPORT2_4, OldTBL_KOTSUHOTEL.REQ_F_AIRPORT2_4)
            Me.REQ_F_TIME1_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TIME1_4, OldTBL_KOTSUHOTEL.REQ_F_TIME1_4)
            Me.REQ_F_TIME2_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TIME2_4, OldTBL_KOTSUHOTEL.REQ_F_TIME2_4)
            Me.REQ_F_BIN_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_BIN_4, OldTBL_KOTSUHOTEL.REQ_F_BIN_4)
            Me.REQ_F_SEAT_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_SEAT_4, OldTBL_KOTSUHOTEL.REQ_F_SEAT_4)
            Me.REQ_F_SEAT_KIBOU4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_SEAT_KIBOU4, OldTBL_KOTSUHOTEL.REQ_F_SEAT_KIBOU4)
            Me.REQ_F_TEHAI_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TEHAI_5, OldTBL_KOTSUHOTEL.REQ_F_TEHAI_5)
            Me.REQ_F_IRAINAIYOU_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_IRAINAIYOU_5, OldTBL_KOTSUHOTEL.REQ_F_IRAINAIYOU_5)
            Me.REQ_F_KOTSUKIKAN_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_KOTSUKIKAN_5, OldTBL_KOTSUHOTEL.REQ_F_KOTSUKIKAN_5)
            Me.REQ_F_DATE_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_DATE_5, OldTBL_KOTSUHOTEL.REQ_F_DATE_5)
            Me.REQ_F_AIRPORT1_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_AIRPORT1_5, OldTBL_KOTSUHOTEL.REQ_F_AIRPORT1_5)
            Me.REQ_F_AIRPORT2_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_AIRPORT2_5, OldTBL_KOTSUHOTEL.REQ_F_AIRPORT2_5)
            Me.REQ_F_TIME1_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TIME1_5, OldTBL_KOTSUHOTEL.REQ_F_TIME1_5)
            Me.REQ_F_TIME2_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_TIME2_5, OldTBL_KOTSUHOTEL.REQ_F_TIME2_5)
            Me.REQ_F_BIN_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_BIN_5, OldTBL_KOTSUHOTEL.REQ_F_BIN_5)
            Me.REQ_F_SEAT_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_SEAT_5, OldTBL_KOTSUHOTEL.REQ_F_SEAT_5)
            Me.REQ_F_SEAT_KIBOU5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_F_SEAT_KIBOU5, OldTBL_KOTSUHOTEL.REQ_F_SEAT_KIBOU5)
            Me.ANS_O_STATUS_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_STATUS_1, OldTBL_KOTSUHOTEL.ANS_O_STATUS_1)
            Me.ANS_O_KOTSUKIKAN_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_KOTSUKIKAN_1, OldTBL_KOTSUHOTEL.ANS_O_KOTSUKIKAN_1)
            Me.ANS_O_DATE_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_DATE_1, OldTBL_KOTSUHOTEL.ANS_O_DATE_1)
            Me.ANS_O_AIRPORT1_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_AIRPORT1_1, OldTBL_KOTSUHOTEL.ANS_O_AIRPORT1_1)
            Me.ANS_O_AIRPORT2_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_AIRPORT2_1, OldTBL_KOTSUHOTEL.ANS_O_AIRPORT2_1)
            Me.ANS_O_TIME1_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_TIME1_1, OldTBL_KOTSUHOTEL.ANS_O_TIME1_1)
            Me.ANS_O_TIME2_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_TIME2_1, OldTBL_KOTSUHOTEL.ANS_O_TIME2_1)
            Me.ANS_O_BIN_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_BIN_1, OldTBL_KOTSUHOTEL.ANS_O_BIN_1)
            Me.ANS_O_SEAT_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_SEAT_1, OldTBL_KOTSUHOTEL.ANS_O_SEAT_1)
            Me.ANS_O_SEAT_KIBOU1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_SEAT_KIBOU1, OldTBL_KOTSUHOTEL.ANS_O_SEAT_KIBOU1)
            Me.ANS_O_STATUS_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_STATUS_2, OldTBL_KOTSUHOTEL.ANS_O_STATUS_2)
            Me.ANS_O_KOTSUKIKAN_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_KOTSUKIKAN_2, OldTBL_KOTSUHOTEL.ANS_O_KOTSUKIKAN_2)
            Me.ANS_O_DATE_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_DATE_2, OldTBL_KOTSUHOTEL.ANS_O_DATE_2)
            Me.ANS_O_AIRPORT1_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_AIRPORT1_2, OldTBL_KOTSUHOTEL.ANS_O_AIRPORT1_2)
            Me.ANS_O_AIRPORT2_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_AIRPORT2_2, OldTBL_KOTSUHOTEL.ANS_O_AIRPORT2_2)
            Me.ANS_O_TIME1_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_TIME1_2, OldTBL_KOTSUHOTEL.ANS_O_TIME1_2)
            Me.ANS_O_TIME2_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_TIME2_2, OldTBL_KOTSUHOTEL.ANS_O_TIME2_2)
            Me.ANS_O_BIN_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_BIN_2, OldTBL_KOTSUHOTEL.ANS_O_BIN_2)
            Me.ANS_O_SEAT_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_SEAT_2, OldTBL_KOTSUHOTEL.ANS_O_SEAT_2)
            Me.ANS_O_SEAT_KIBOU2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_SEAT_KIBOU2, OldTBL_KOTSUHOTEL.ANS_O_SEAT_KIBOU2)
            Me.ANS_O_STATUS_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_STATUS_3, OldTBL_KOTSUHOTEL.ANS_O_STATUS_3)
            Me.ANS_O_KOTSUKIKAN_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_KOTSUKIKAN_3, OldTBL_KOTSUHOTEL.ANS_O_KOTSUKIKAN_3)
            Me.ANS_O_DATE_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_DATE_3, OldTBL_KOTSUHOTEL.ANS_O_DATE_3)
            Me.ANS_O_AIRPORT1_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_AIRPORT1_3, OldTBL_KOTSUHOTEL.ANS_O_AIRPORT1_3)
            Me.ANS_O_AIRPORT2_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_AIRPORT2_3, OldTBL_KOTSUHOTEL.ANS_O_AIRPORT2_3)
            Me.ANS_O_TIME1_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_TIME1_3, OldTBL_KOTSUHOTEL.ANS_O_TIME1_3)
            Me.ANS_O_TIME2_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_TIME2_3, OldTBL_KOTSUHOTEL.ANS_O_TIME2_3)
            Me.ANS_O_BIN_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_BIN_3, OldTBL_KOTSUHOTEL.ANS_O_BIN_3)
            Me.ANS_O_SEAT_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_SEAT_3, OldTBL_KOTSUHOTEL.ANS_O_SEAT_3)
            Me.ANS_O_SEAT_KIBOU3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_SEAT_KIBOU3, OldTBL_KOTSUHOTEL.ANS_O_SEAT_KIBOU3)
            Me.ANS_O_STATUS_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_STATUS_4, OldTBL_KOTSUHOTEL.ANS_O_STATUS_4)
            Me.ANS_O_KOTSUKIKAN_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_KOTSUKIKAN_4, OldTBL_KOTSUHOTEL.ANS_O_KOTSUKIKAN_4)
            Me.ANS_O_DATE_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_DATE_4, OldTBL_KOTSUHOTEL.ANS_O_DATE_4)
            Me.ANS_O_AIRPORT1_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_AIRPORT1_4, OldTBL_KOTSUHOTEL.ANS_O_AIRPORT1_4)
            Me.ANS_O_AIRPORT2_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_AIRPORT2_4, OldTBL_KOTSUHOTEL.ANS_O_AIRPORT2_4)
            Me.ANS_O_TIME1_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_TIME1_4, OldTBL_KOTSUHOTEL.ANS_O_TIME1_4)
            Me.ANS_O_TIME2_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_TIME2_4, OldTBL_KOTSUHOTEL.ANS_O_TIME2_4)
            Me.ANS_O_BIN_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_BIN_4, OldTBL_KOTSUHOTEL.ANS_O_BIN_4)
            Me.ANS_O_SEAT_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_SEAT_4, OldTBL_KOTSUHOTEL.ANS_O_SEAT_4)
            Me.ANS_O_SEAT_KIBOU4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_SEAT_KIBOU4, OldTBL_KOTSUHOTEL.ANS_O_SEAT_KIBOU4)
            Me.ANS_O_STATUS_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_STATUS_5, OldTBL_KOTSUHOTEL.ANS_O_STATUS_5)
            Me.ANS_O_KOTSUKIKAN_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_KOTSUKIKAN_5, OldTBL_KOTSUHOTEL.ANS_O_KOTSUKIKAN_5)
            Me.ANS_O_DATE_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_DATE_5, OldTBL_KOTSUHOTEL.ANS_O_DATE_5)
            Me.ANS_O_AIRPORT1_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_AIRPORT1_5, OldTBL_KOTSUHOTEL.ANS_O_AIRPORT1_5)
            Me.ANS_O_AIRPORT2_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_AIRPORT2_5, OldTBL_KOTSUHOTEL.ANS_O_AIRPORT2_5)
            Me.ANS_O_TIME1_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_TIME1_5, OldTBL_KOTSUHOTEL.ANS_O_TIME1_5)
            Me.ANS_O_TIME2_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_TIME2_5, OldTBL_KOTSUHOTEL.ANS_O_TIME2_5)
            Me.ANS_O_BIN_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_BIN_5, OldTBL_KOTSUHOTEL.ANS_O_BIN_5)
            Me.ANS_O_SEAT_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_SEAT_5, OldTBL_KOTSUHOTEL.ANS_O_SEAT_5)
            Me.ANS_O_SEAT_KIBOU5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_O_SEAT_KIBOU5, OldTBL_KOTSUHOTEL.ANS_O_SEAT_KIBOU5)
            Me.ANS_F_STATUS_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_STATUS_1, OldTBL_KOTSUHOTEL.ANS_F_STATUS_1)
            Me.ANS_F_KOTSUKIKAN_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_KOTSUKIKAN_1, OldTBL_KOTSUHOTEL.ANS_F_KOTSUKIKAN_1)
            Me.ANS_F_DATE_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_DATE_1, OldTBL_KOTSUHOTEL.ANS_F_DATE_1)
            Me.ANS_F_AIRPORT1_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_AIRPORT1_1, OldTBL_KOTSUHOTEL.ANS_F_AIRPORT1_1)
            Me.ANS_F_AIRPORT2_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_AIRPORT2_1, OldTBL_KOTSUHOTEL.ANS_F_AIRPORT2_1)
            Me.ANS_F_TIME1_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_TIME1_1, OldTBL_KOTSUHOTEL.ANS_F_TIME1_1)
            Me.ANS_F_TIME2_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_TIME2_1, OldTBL_KOTSUHOTEL.ANS_F_TIME2_1)
            Me.ANS_F_BIN_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_BIN_1, OldTBL_KOTSUHOTEL.ANS_F_BIN_1)
            Me.ANS_F_SEAT_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_SEAT_1, OldTBL_KOTSUHOTEL.ANS_F_SEAT_1)
            Me.ANS_F_SEAT_KIBOU1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_SEAT_KIBOU1, OldTBL_KOTSUHOTEL.ANS_F_SEAT_KIBOU1)
            Me.ANS_F_STATUS_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_STATUS_2, OldTBL_KOTSUHOTEL.ANS_F_STATUS_2)
            Me.ANS_F_KOTSUKIKAN_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_KOTSUKIKAN_2, OldTBL_KOTSUHOTEL.ANS_F_KOTSUKIKAN_2)
            Me.ANS_F_DATE_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_DATE_2, OldTBL_KOTSUHOTEL.ANS_F_DATE_2)
            Me.ANS_F_AIRPORT1_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_AIRPORT1_2, OldTBL_KOTSUHOTEL.ANS_F_AIRPORT1_2)
            Me.ANS_F_AIRPORT2_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_AIRPORT2_2, OldTBL_KOTSUHOTEL.ANS_F_AIRPORT2_2)
            Me.ANS_F_TIME1_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_TIME1_2, OldTBL_KOTSUHOTEL.ANS_F_TIME1_2)
            Me.ANS_F_TIME2_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_TIME2_2, OldTBL_KOTSUHOTEL.ANS_F_TIME2_2)
            Me.ANS_F_BIN_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_BIN_2, OldTBL_KOTSUHOTEL.ANS_F_BIN_2)
            Me.ANS_F_SEAT_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_SEAT_2, OldTBL_KOTSUHOTEL.ANS_F_SEAT_2)
            Me.ANS_F_SEAT_KIBOU2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_SEAT_KIBOU2, OldTBL_KOTSUHOTEL.ANS_F_SEAT_KIBOU2)
            Me.ANS_F_STATUS_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_STATUS_3, OldTBL_KOTSUHOTEL.ANS_F_STATUS_3)
            Me.ANS_F_KOTSUKIKAN_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_KOTSUKIKAN_3, OldTBL_KOTSUHOTEL.ANS_F_KOTSUKIKAN_3)
            Me.ANS_F_DATE_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_DATE_3, OldTBL_KOTSUHOTEL.ANS_F_DATE_3)
            Me.ANS_F_AIRPORT1_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_AIRPORT1_3, OldTBL_KOTSUHOTEL.ANS_F_AIRPORT1_3)
            Me.ANS_F_AIRPORT2_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_AIRPORT2_3, OldTBL_KOTSUHOTEL.ANS_F_AIRPORT2_3)
            Me.ANS_F_TIME1_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_TIME1_3, OldTBL_KOTSUHOTEL.ANS_F_TIME1_3)
            Me.ANS_F_TIME2_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_TIME2_3, OldTBL_KOTSUHOTEL.ANS_F_TIME2_3)
            Me.ANS_F_BIN_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_BIN_3, OldTBL_KOTSUHOTEL.ANS_F_BIN_3)
            Me.ANS_F_SEAT_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_SEAT_3, OldTBL_KOTSUHOTEL.ANS_F_SEAT_3)
            Me.ANS_F_SEAT_KIBOU3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_SEAT_KIBOU3, OldTBL_KOTSUHOTEL.ANS_F_SEAT_KIBOU3)
            Me.ANS_F_STATUS_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_STATUS_4, OldTBL_KOTSUHOTEL.ANS_F_STATUS_4)
            Me.ANS_F_KOTSUKIKAN_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_KOTSUKIKAN_4, OldTBL_KOTSUHOTEL.ANS_F_KOTSUKIKAN_4)
            Me.ANS_F_DATE_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_DATE_4, OldTBL_KOTSUHOTEL.ANS_F_DATE_4)
            Me.ANS_F_AIRPORT1_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_AIRPORT1_4, OldTBL_KOTSUHOTEL.ANS_F_AIRPORT1_4)
            Me.ANS_F_AIRPORT2_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_AIRPORT2_4, OldTBL_KOTSUHOTEL.ANS_F_AIRPORT2_4)
            Me.ANS_F_TIME1_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_TIME1_4, OldTBL_KOTSUHOTEL.ANS_F_TIME1_4)
            Me.ANS_F_TIME2_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_TIME2_4, OldTBL_KOTSUHOTEL.ANS_F_TIME2_4)
            Me.ANS_F_BIN_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_BIN_4, OldTBL_KOTSUHOTEL.ANS_F_BIN_4)
            Me.ANS_F_SEAT_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_SEAT_4, OldTBL_KOTSUHOTEL.ANS_F_SEAT_4)
            Me.ANS_F_SEAT_KIBOU4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_SEAT_KIBOU4, OldTBL_KOTSUHOTEL.ANS_F_SEAT_KIBOU4)
            Me.ANS_F_STATUS_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_STATUS_5, OldTBL_KOTSUHOTEL.ANS_F_STATUS_5)
            Me.ANS_F_KOTSUKIKAN_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_KOTSUKIKAN_5, OldTBL_KOTSUHOTEL.ANS_F_KOTSUKIKAN_5)
            Me.ANS_F_DATE_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_DATE_5, OldTBL_KOTSUHOTEL.ANS_F_DATE_5)
            Me.ANS_F_AIRPORT1_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_AIRPORT1_5, OldTBL_KOTSUHOTEL.ANS_F_AIRPORT1_5)
            Me.ANS_F_AIRPORT2_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_AIRPORT2_5, OldTBL_KOTSUHOTEL.ANS_F_AIRPORT2_5)
            Me.ANS_F_TIME1_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_TIME1_5, OldTBL_KOTSUHOTEL.ANS_F_TIME1_5)
            Me.ANS_F_TIME2_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_TIME2_5, OldTBL_KOTSUHOTEL.ANS_F_TIME2_5)
            Me.ANS_F_BIN_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_BIN_5, OldTBL_KOTSUHOTEL.ANS_F_BIN_5)
            Me.ANS_F_SEAT_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_SEAT_5, OldTBL_KOTSUHOTEL.ANS_F_SEAT_5)
            Me.ANS_F_SEAT_KIBOU5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_F_SEAT_KIBOU5, OldTBL_KOTSUHOTEL.ANS_F_SEAT_KIBOU5)
            Me.REQ_KOTSU_BIKO.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_KOTSU_BIKO, OldTBL_KOTSUHOTEL.REQ_KOTSU_BIKO)
            Me.ANS_KOTSU_BIKO.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_KOTSU_BIKO, OldTBL_KOTSUHOTEL.ANS_KOTSU_BIKO)
            Me.TEHAI_TAXI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TEHAI_TAXI, OldTBL_KOTSUHOTEL.TEHAI_TAXI)
            Me.REQ_TAXI_NOTE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_NOTE, OldTBL_KOTSUHOTEL.REQ_TAXI_NOTE)
            Me.REQ_TAXI_DATE_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_DATE_1, OldTBL_KOTSUHOTEL.REQ_TAXI_DATE_1)
            Me.REQ_TAXI_FROM_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_FROM_1, OldTBL_KOTSUHOTEL.REQ_TAXI_FROM_1)
            Me.TAXI_YOTEIKINGAKU_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TAXI_YOTEIKINGAKU_1, OldTBL_KOTSUHOTEL.TAXI_YOTEIKINGAKU_1)
            Me.REQ_TAXI_DATE_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_DATE_2, OldTBL_KOTSUHOTEL.REQ_TAXI_DATE_2)
            Me.REQ_TAXI_FROM_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_FROM_2, OldTBL_KOTSUHOTEL.REQ_TAXI_FROM_2)
            Me.TAXI_YOTEIKINGAKU_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TAXI_YOTEIKINGAKU_2, OldTBL_KOTSUHOTEL.TAXI_YOTEIKINGAKU_2)
            Me.REQ_TAXI_DATE_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_DATE_3, OldTBL_KOTSUHOTEL.REQ_TAXI_DATE_3)
            Me.REQ_TAXI_FROM_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_FROM_3, OldTBL_KOTSUHOTEL.REQ_TAXI_FROM_3)
            Me.TAXI_YOTEIKINGAKU_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TAXI_YOTEIKINGAKU_3, OldTBL_KOTSUHOTEL.TAXI_YOTEIKINGAKU_3)
            Me.REQ_TAXI_DATE_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_DATE_4, OldTBL_KOTSUHOTEL.REQ_TAXI_DATE_4)
            Me.REQ_TAXI_FROM_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_FROM_4, OldTBL_KOTSUHOTEL.REQ_TAXI_FROM_4)
            Me.TAXI_YOTEIKINGAKU_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TAXI_YOTEIKINGAKU_4, OldTBL_KOTSUHOTEL.TAXI_YOTEIKINGAKU_4)
            Me.REQ_TAXI_DATE_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_DATE_5, OldTBL_KOTSUHOTEL.REQ_TAXI_DATE_5)
            Me.REQ_TAXI_FROM_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_FROM_5, OldTBL_KOTSUHOTEL.REQ_TAXI_FROM_5)
            Me.TAXI_YOTEIKINGAKU_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TAXI_YOTEIKINGAKU_5, OldTBL_KOTSUHOTEL.TAXI_YOTEIKINGAKU_5)
            Me.REQ_TAXI_DATE_6.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_DATE_6, OldTBL_KOTSUHOTEL.REQ_TAXI_DATE_6)
            Me.REQ_TAXI_FROM_6.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_FROM_6, OldTBL_KOTSUHOTEL.REQ_TAXI_FROM_6)
            Me.TAXI_YOTEIKINGAKU_6.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TAXI_YOTEIKINGAKU_6, OldTBL_KOTSUHOTEL.TAXI_YOTEIKINGAKU_6)
            Me.REQ_TAXI_DATE_7.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_DATE_7, OldTBL_KOTSUHOTEL.REQ_TAXI_DATE_7)
            Me.REQ_TAXI_FROM_7.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_FROM_7, OldTBL_KOTSUHOTEL.REQ_TAXI_FROM_7)
            Me.TAXI_YOTEIKINGAKU_7.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TAXI_YOTEIKINGAKU_7, OldTBL_KOTSUHOTEL.TAXI_YOTEIKINGAKU_7)
            Me.REQ_TAXI_DATE_8.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_DATE_8, OldTBL_KOTSUHOTEL.REQ_TAXI_DATE_8)
            Me.REQ_TAXI_FROM_8.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_FROM_8, OldTBL_KOTSUHOTEL.REQ_TAXI_FROM_8)
            Me.TAXI_YOTEIKINGAKU_8.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TAXI_YOTEIKINGAKU_8, OldTBL_KOTSUHOTEL.TAXI_YOTEIKINGAKU_8)
            Me.REQ_TAXI_DATE_9.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_DATE_9, OldTBL_KOTSUHOTEL.REQ_TAXI_DATE_9)
            Me.REQ_TAXI_FROM_9.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_FROM_9, OldTBL_KOTSUHOTEL.REQ_TAXI_FROM_9)
            Me.TAXI_YOTEIKINGAKU_9.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TAXI_YOTEIKINGAKU_9, OldTBL_KOTSUHOTEL.TAXI_YOTEIKINGAKU_9)
            Me.REQ_TAXI_DATE_10.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_DATE_10, OldTBL_KOTSUHOTEL.REQ_TAXI_DATE_10)
            Me.REQ_TAXI_FROM_10.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_TAXI_FROM_10, OldTBL_KOTSUHOTEL.REQ_TAXI_FROM_10)
            Me.TAXI_YOTEIKINGAKU_10.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).TAXI_YOTEIKINGAKU_10, OldTBL_KOTSUHOTEL.TAXI_YOTEIKINGAKU_10)
            Me.ANS_TAXI_DATE_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_1, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_1)
            Me.ANS_TAXI_KENSHU_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_1, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_1)
            Me.ANS_TAXI_NO_1.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_1, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_1)
            Me.ANS_TAXI_DATE_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_2, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_2)
            Me.ANS_TAXI_KENSHU_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_2, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_2)
            Me.ANS_TAXI_NO_2.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_2, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_2)
            Me.ANS_TAXI_DATE_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_3, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_3)
            Me.ANS_TAXI_KENSHU_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_3, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_3)
            Me.ANS_TAXI_NO_3.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_3, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_3)
            Me.ANS_TAXI_DATE_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_4, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_4)
            Me.ANS_TAXI_KENSHU_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_4, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_4)
            Me.ANS_TAXI_NO_4.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_4, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_4)
            Me.ANS_TAXI_DATE_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_5, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_5)
            Me.ANS_TAXI_KENSHU_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_5, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_5)
            Me.ANS_TAXI_NO_5.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_5, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_5)
            Me.ANS_TAXI_DATE_6.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_6, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_6)
            Me.ANS_TAXI_KENSHU_6.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_6, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_6)
            Me.ANS_TAXI_NO_6.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_6, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_6)
            Me.ANS_TAXI_DATE_7.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_7, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_7)
            Me.ANS_TAXI_KENSHU_7.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_7, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_7)
            Me.ANS_TAXI_NO_7.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_7, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_7)
            Me.ANS_TAXI_DATE_8.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_8, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_8)
            Me.ANS_TAXI_KENSHU_8.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_8, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_8)
            Me.ANS_TAXI_NO_8.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_8, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_8)
            Me.ANS_TAXI_DATE_9.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_9, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_9)
            Me.ANS_TAXI_KENSHU_9.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_9, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_9)
            Me.ANS_TAXI_NO_9.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_9, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_9)
            Me.ANS_TAXI_DATE_10.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_10, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_10)
            Me.ANS_TAXI_KENSHU_10.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_10, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_10)
            Me.ANS_TAXI_NO_10.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_10, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_10)
            Me.ANS_TAXI_DATE_11.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_11, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_11)
            Me.ANS_TAXI_KENSHU_11.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_11, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_11)
            Me.ANS_TAXI_NO_11.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_11, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_11)
            Me.ANS_TAXI_DATE_12.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_12, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_12)
            Me.ANS_TAXI_KENSHU_12.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_12, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_12)
            Me.ANS_TAXI_NO_12.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_12, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_12)
            Me.ANS_TAXI_DATE_13.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_13, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_13)
            Me.ANS_TAXI_KENSHU_13.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_13, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_13)
            Me.ANS_TAXI_NO_13.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_13, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_13)
            Me.ANS_TAXI_DATE_14.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_14, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_14)
            Me.ANS_TAXI_KENSHU_14.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_14, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_14)
            Me.ANS_TAXI_NO_14.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_14, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_14)
            Me.ANS_TAXI_DATE_15.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_15, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_15)
            Me.ANS_TAXI_KENSHU_15.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_15, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_15)
            Me.ANS_TAXI_NO_15.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_15, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_15)
            Me.ANS_TAXI_DATE_16.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_16, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_16)
            Me.ANS_TAXI_KENSHU_16.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_16, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_16)
            Me.ANS_TAXI_NO_16.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_16, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_16)
            Me.ANS_TAXI_DATE_17.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_17, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_17)
            Me.ANS_TAXI_KENSHU_17.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_17, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_17)
            Me.ANS_TAXI_NO_17.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_17, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_17)
            Me.ANS_TAXI_DATE_18.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_18, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_18)
            Me.ANS_TAXI_KENSHU_18.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_18, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_18)
            Me.ANS_TAXI_NO_18.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_18, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_18)
            Me.ANS_TAXI_DATE_19.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_19, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_19)
            Me.ANS_TAXI_KENSHU_19.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_19, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_19)
            Me.ANS_TAXI_NO_19.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_19, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_19)
            Me.ANS_TAXI_DATE_20.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_DATE_20, OldTBL_KOTSUHOTEL.ANS_TAXI_DATE_20)
            Me.ANS_TAXI_KENSHU_20.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_KENSHU_20, OldTBL_KOTSUHOTEL.ANS_TAXI_KENSHU_20)
            Me.ANS_TAXI_NO_20.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_NO_20, OldTBL_KOTSUHOTEL.ANS_TAXI_NO_20)
            Me.REQ_MR_O_TEHAI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_MR_O_TEHAI, OldTBL_KOTSUHOTEL.REQ_MR_O_TEHAI)
            Me.REQ_MR_F_TEHAI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_MR_F_TEHAI, OldTBL_KOTSUHOTEL.REQ_MR_F_TEHAI)
            Me.MR_SEX.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_SEX, OldTBL_KOTSUHOTEL.MR_SEX)
            Me.MR_AGE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).MR_AGE, OldTBL_KOTSUHOTEL.MR_AGE)
            Me.REQ_MR_HOTEL_NOTE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).REQ_MR_HOTEL_NOTE, OldTBL_KOTSUHOTEL.REQ_MR_HOTEL_NOTE)
            Me.ANS_MR_O_TEHAI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_MR_O_TEHAI, OldTBL_KOTSUHOTEL.ANS_MR_O_TEHAI)
            Me.ANS_MR_F_TEHAI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_MR_F_TEHAI, OldTBL_KOTSUHOTEL.ANS_MR_F_TEHAI)
            Me.ANS_MR_HOTEL_NOTE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_MR_HOTEL_NOTE, OldTBL_KOTSUHOTEL.ANS_MR_HOTEL_NOTE)
            Me.ANS_HOTELHI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_HOTELHI, OldTBL_KOTSUHOTEL.ANS_HOTELHI)
            Me.ANS_HOTELHI_TOZEI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_HOTELHI_TOZEI, OldTBL_KOTSUHOTEL.ANS_HOTELHI_TOZEI)
            Me.ANS_AIR_FARE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_AIR_FARE, OldTBL_KOTSUHOTEL.ANS_AIR_FARE)
            Me.ANS_AIR_CANCELLATION.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_AIR_CANCELLATION, OldTBL_KOTSUHOTEL.ANS_AIR_CANCELLATION)
            Me.ANS_RAIL_FARE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_RAIL_FARE, OldTBL_KOTSUHOTEL.ANS_RAIL_FARE)
            Me.ANS_RAIL_CANCELLATION.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_RAIL_CANCELLATION, OldTBL_KOTSUHOTEL.ANS_RAIL_CANCELLATION)
            Me.ANS_OTHER_FARE.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_OTHER_FARE, OldTBL_KOTSUHOTEL.ANS_OTHER_FARE)
            Me.ANS_OTHER_CANCELLATION.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_OTHER_CANCELLATION, OldTBL_KOTSUHOTEL.ANS_OTHER_CANCELLATION)
            Me.ANS_KOTSUHOTEL_TESURYO.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_KOTSUHOTEL_TESURYO, OldTBL_KOTSUHOTEL.ANS_KOTSUHOTEL_TESURYO)
            Me.ANS_TAXI_TESURYO.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_TAXI_TESURYO, OldTBL_KOTSUHOTEL.ANS_TAXI_TESURYO)
            Me.ANS_MR_HOTELHI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_MR_HOTELHI, OldTBL_KOTSUHOTEL.ANS_MR_HOTELHI)
            Me.ANS_MR_HOTELHI_TOZEI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_MR_HOTELHI_TOZEI, OldTBL_KOTSUHOTEL.ANS_MR_HOTELHI_TOZEI)
            Me.ANS_MR_KOTSUHI.ForeColor = SetChangedColor(DSP_KOTSUHOTEL(DSP_SEQ).ANS_MR_KOTSUHI, OldTBL_KOTSUHOTEL.ANS_MR_KOTSUHI)
        End If

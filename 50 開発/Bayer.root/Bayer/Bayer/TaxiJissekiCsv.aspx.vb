...
#Region "デリゲート"
    ...
    Public Function CsvMethod(ByVal intLoop As Integer, ByRef format As String) As String
        ...
        Try
            CmnDb.ExecuteForDeligate(strSQL3, MyBase.DbConnection)
        Catch ex As Exception
        ...
        RsData2 = CmnDb.ReadForDeligate(strSQL2, MyBase.DbConnection)
        ...
        sb.Append(CmnCsv.SetData(CmnCsv.Quotes("発行券種(金額)"), True))
        sb.Append(vbNewLine)
        ...
        While RsData2.Read()
            ...
            sb.Append(CmnCsv.SetData(CmnCsv.Quotes(CsvData(wCnt).TKT_KENSHU), True))
            sb.Append(vbNewLine)

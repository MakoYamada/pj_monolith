...
Public Class DrSoufujo
    ...
    Private HotelItemTitleX1 As Single = 0
    Private HotelItemTitleX2 As Single = 0
    Private KotsuItemTitleX1 As Single = 0
    Private KotsuItemTitleX2 As Single = 0
    Private KotsuItemTitleX3 As Single = 0
    Private KotsuItemX2 As Single = 0
    Private KotsuItemX3 As Single = 0
    Private TaxiItemTitleX1 As Single = 0
    Private TaxiItemTitleX2 As Single = 0
    Private TaxiItemX1 As Single = 0
    Private TaxiItemX2 As Single = 0
    Private TaxiItemX3 As Single = 0
    Private TaxiItemX4 As Single = 0
    ...
    Private Sub Detail_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail.Format
        ...
        'If DR_SHISETSU_NAME.Text.Length > 20 Then DR_SHISETSU_NAME.Text = Left(DR_SHISETSU_NAME.Text, 20)
        'If DR_SHISETSU_NAME2.Text.Length > 20 Then DR_SHISETSU_NAME2.Text = Left(DR_SHISETSU_NAME2.Text, 20)
        'If DR_SHISETSU_ADDRESS.Text.Length > 20 Then DR_SHISETSU_ADDRESS.Text = Left(DR_SHISETSU_ADDRESS.Text, 20)
        'If DR_SHISETSU_ADDRESS2.Text.Length > 20 Then DR_SHISETSU_ADDRESS2.Text = Left(DR_SHISETSU_ADDRESS2.Text, 20)

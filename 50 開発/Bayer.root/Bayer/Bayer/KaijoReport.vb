...
Public Class KaijoReport
    ...
    Private Sub Detail_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail.Format
        ...
        If pRireki = False AndAlso Trim(pOldTBL_KAIJO.KOUENKAI_NO) <> "" Then
            ...
            SetChangedColor(Me.KAISAI_DATE_NOTE, pOldTBL_KAIJO.KAISAI_KIBOU_NOTE, Me.KAISAI_DATE_NOTE.Text)
            SetChangedColor(Me.IKENKOUKAN_KAIJO_TEHAI_Yes, pOldTBL_KAIJO.IKENKOUKAN_KAIJO_TEHAI, Me.IKENKOUKAN_KAIJO_TEHAI_Yes.Text)
            SetChangedColor(Me.IKENKOUKAN_KAIJO_TEHAI_No, pOldTBL_KAIJO.IKENKOUKAN_KAIJO_TEHAI, Me.IKENKOUKAN_KAIJO_TEHAI_No.Text)
            SetChangedColor(Me.IROUKAI_KAIJO_TEHAI_Yes, pOldTBL_KAIJO.IROUKAI_KAIJO_TEHAI, Me.IROUKAI_KAIJO_TEHAI_Yes.Text)
            SetChangedColor(Me.IROUKAI_KAIJO_TEHAI_No, pOldTBL_KAIJO.IROUKAI_KAIJO_TEHAI, Me.IROUKAI_KAIJO_TEHAI_No.Text)
            SetChangedColor(Me.IROUKAI_SANKA_YOTEI_CNT, pOldTBL_KAIJO.IROUKAI_SANKA_YOTEI_CNT, Me.IROUKAI_SANKA_YOTEI_CNT.Text)
            SetChangedColor(Me.KOUSHI_ROOM_TEHAI_Yes, pOldTBL_KAIJO.KOUSHI_ROOM_TEHAI, Me.KOUSHI_ROOM_TEHAI_Yes.Text)
            SetChangedColor(Me.KOUSHI_ROOM_TEHAI_No, pOldTBL_KAIJO.KOUSHI_ROOM_TEHAI, Me.KOUSHI_ROOM_TEHAI_No.Text)
            ...
            SetChangedColor(Me.SHAIN_ROOM_TEHAI_Yes, pOldTBL_KAIJO.SHAIN_ROOM_TEHAI, Me.SHAIN_ROOM_TEHAI_Yes.Text)
            SetChangedColor(Me.SHAIN_ROOM_TEHAI_No, pOldTBL_KAIJO.SHAIN_ROOM_TEHAI, Me.SHAIN_ROOM_TEHAI_No.Text)
            SetChangedColor(Me.SHAIN_ROOM_CNT, pOldTBL_KAIJO.SHAIN_ROOM_CNT, Me.SHAIN_ROOM_CNT.Text)
            SetChangedColor(Me.MANAGER_KAIJO_TEHAI_Yes, pOldTBL_KAIJO.MANAGER_KAIJO_TEHAI, Me.MANAGER_KAIJO_TEHAI_Yes.Text)
            SetChangedColor(Me.MANAGER_KAIJO_TEHAI_No, pOldTBL_KAIJO.MANAGER_KAIJO_TEHAI, Me.MANAGER_KAIJO_TEHAI_No.Text)
        ...
        Me.KAISAI_DATE_NOTE.Text = AppModule.GetName_KAISAI_KIBOU_NOTE(Me.KAISAI_DATE_NOTE.Text)
        Me.IKENKOUKAN_KAIJO_TEHAI_Yes.Text = AppModule.GetName_IKENKOUKAN_KAIJO_TEHAI_Yes(Me.IKENKOUKAN_KAIJO_TEHAI_Yes.Text)
        Me.IKENKOUKAN_KAIJO_TEHAI_No.Text = AppModule.GetName_IKENKOUKAN_KAIJO_TEHAI_No(Me.IKENKOUKAN_KAIJO_TEHAI_No.Text)
        Me.IROUKAI_KAIJO_TEHAI_Yes.Text = AppModule.GetName_IROUKAI_KAIJO_TEHAI_Yes(Me.IROUKAI_KAIJO_TEHAI_Yes.Text)
        Me.IROUKAI_KAIJO_TEHAI_No.Text = AppModule.GetName_IROUKAI_KAIJO_TEHAI_No(Me.IROUKAI_KAIJO_TEHAI_No.Text)
        Me.IROUKAI_SANKA_YOTEI_CNT.Text = AppModule.GetName_IROUKAI_SANKA_YOTEI_CNT(Me.IROUKAI_SANKA_YOTEI_CNT.Text) & "名"
        Me.KOUSHI_ROOM_TEHAI_Yes.Text = AppModule.GetName_KOUSHI_ROOM_TEHAI_Yes(Me.KOUSHI_ROOM_TEHAI_Yes.Text)
        Me.KOUSHI_ROOM_TEHAI_No.Text = AppModule.GetName_KOUSHI_ROOM_TEHAI_No(Me.KOUSHI_ROOM_TEHAI_No.Text)
        ...
        Me.SHAIN_ROOM_TEHAI_Yes.Text = AppModule.GetName_SHAIN_ROOM_TEHAI_Yes(Me.SHAIN_ROOM_TEHAI_Yes.Text)
        Me.SHAIN_ROOM_TEHAI_No.Text = AppModule.GetName_SHAIN_ROOM_TEHAI_No(Me.SHAIN_ROOM_TEHAI_No.Text)
        Me.SHAIN_ROOM_CNT.Text = AppModule.GetName_SHAIN_ROOM_CNT(Me.SHAIN_ROOM_CNT.Text) & "名"
        Me.MANAGER_KAIJO_TEHAI_Yes.Text = AppModule.GetName_MANAGER_KAIJO_TEHAI_Yes(Me.MANAGER_KAIJO_TEHAI_Yes.Text)
        Me.MANAGER_KAIJO_TEHAI_No.Text = AppModule.GetName_MANAGER_KAIJO_TEHAI_No(Me.MANAGER_KAIJO_TEHAI_No.Text)
    ...
    Private Sub SetChangedColor(ByRef control As TextBox, ByVal Data1 As String, ByVal Data2 As String)
        With control
            If CmnModule.IsChanged(Data1, Data2) Then
                .BackColor = Drawing.Color.FromArgb(250, 250, 10)
            Else

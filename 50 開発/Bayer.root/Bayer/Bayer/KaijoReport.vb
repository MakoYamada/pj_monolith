...
Public Class KaijoReport
    ...
    Private Sub Detail_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail.Format
        ...
        If pRireki = False AndAlso Trim(pOldTBL_KAIJO.KOUENKAI_NO) <> "" Then
            ...
            SetChangedColor(Me.FROM_DATE, pOldTBL_KAIJO.FROM_DATE, Me.FROM_DATE.Text)
            SetChangedColor(Me.TAXI_PRT_NAME, pOldTBL_KAIJO.TAXI_PRT_NAME, Me.TAXI_PRT_NAME.Text)
            SetChangedColor(Me.TO_DATE, pOldTBL_KAIJO.TO_DATE, Me.TO_DATE.Text)
            SetChangedColor(Me.SEIHIN_NAME, pOldTBL_KAIJO.SEIHIN_NAME, Me.SEIHIN_NAME.Text)
            SetChangedColor(Me.INTERNAL_ORDER_T, pOldTBL_KAIJO.INTERNAL_ORDER_T, Me.INTERNAL_ORDER_T.Text)
            SetChangedColor(Me.INTERNAL_ORDER_TF, pOldTBL_KAIJO.INTERNAL_ORDER_TF, Me.INTERNAL_ORDER_TF.Text)
            SetChangedColor(Me.ACCOUNT_CD_T, pOldTBL_KAIJO.ACCOUNT_CD_T, Me.ACCOUNT_CD_T.Text)
            SetChangedColor(Me.ACCOUNT_CD_TF, pOldTBL_KAIJO.ACCOUNT_CD_TF, Me.ACCOUNT_CD_TF.Text)
            ...
            SetChangedColor(Me.IKENKOUKAN_KAIJO_TEHAI_Yes, pOldTBL_KAIJO.IKENKOUKAN_KAIJO_TEHAI, Me.IKENKOUKAN_KAIJO_TEHAI.Text)
            SetChangedColor(Me.IKENKOUKAN_KAIJO_TEHAI_No, pOldTBL_KAIJO.IKENKOUKAN_KAIJO_TEHAI, Me.IKENKOUKAN_KAIJO_TEHAI.Text)
            SetChangedColor(Me.IROUKAI_KAIJO_TEHAI_Yes, pOldTBL_KAIJO.IROUKAI_KAIJO_TEHAI, Me.IROUKAI_KAIJO_TEHAI.Text)
            SetChangedColor(Me.IROUKAI_KAIJO_TEHAI_No, pOldTBL_KAIJO.IROUKAI_KAIJO_TEHAI, Me.IROUKAI_KAIJO_TEHAI.Text)
            SetChangedColor(Me.KOUSHI_ROOM_TEHAI_Yes, pOldTBL_KAIJO.KOUSHI_ROOM_TEHAI, Me.KOUSHI_ROOM_TEHAI.Text)
            SetChangedColor(Me.KOUSHI_ROOM_TEHAI_No, pOldTBL_KAIJO.KOUSHI_ROOM_TEHAI, Me.KOUSHI_ROOM_TEHAI.Text)
            SetChangedColor(Me.SHAIN_ROOM_TEHAI_Yes, pOldTBL_KAIJO.SHAIN_ROOM_TEHAI, Me.SHAIN_ROOM_TEHAI.Text)
            SetChangedColor(Me.SHAIN_ROOM_TEHAI_No, pOldTBL_KAIJO.SHAIN_ROOM_TEHAI, Me.SHAIN_ROOM_TEHAI.Text)
            SetChangedColor(Me.MANAGER_KAIJO_TEHAI_Yes, pOldTBL_KAIJO.MANAGER_KAIJO_TEHAI, Me.MANAGER_KAIJO_TEHAI.Text)
            SetChangedColor(Me.MANAGER_KAIJO_TEHAI_No, pOldTBL_KAIJO.MANAGER_KAIJO_TEHAI, Me.MANAGER_KAIJO_TEHAI.Text)
        ...
        If Trim(Me.TO_DATE.Text) <> "" Then
            Me.FROM_DATE.Text &= "～"
            Me.FROM_DATE.Text &= AppModule.GetName_TO_DATE(Me.TO_DATE.Text)
        End If
        ...
        Me.INTERNAL_ORDER_T.Text = AppModule.GetName_INTERNAL_ORDER_T(Me.INTERNAL_ORDER_T.Text)
        Me.INTERNAL_ORDER_TF.Text = AppModule.GetName_INTERNAL_ORDER_TF(Me.INTERNAL_ORDER_TF.Text)
        Me.ACCOUNT_CD_T.Text = AppModule.GetName_ACCOUNT_CD_T(Me.ACCOUNT_CD_T.Text)
        Me.ACCOUNT_CD_TF.Text = AppModule.GetName_ACCOUNT_CD_TF(Me.ACCOUNT_CD_TF.Text)
        ...
        Me.IKENKOUKAN_KAIJO_TEHAI_Yes.Text = AppModule.GetName_IKENKOUKAN_KAIJO_TEHAI_Yes(Me.IKENKOUKAN_KAIJO_TEHAI.Text)
        Me.IKENKOUKAN_KAIJO_TEHAI_No.Text = AppModule.GetName_IKENKOUKAN_KAIJO_TEHAI_No(Me.IKENKOUKAN_KAIJO_TEHAI.Text)
        Me.IROUKAI_KAIJO_TEHAI_Yes.Text = AppModule.GetName_IROUKAI_KAIJO_TEHAI_Yes(Me.IROUKAI_KAIJO_TEHAI.Text)
        Me.IROUKAI_KAIJO_TEHAI_No.Text = AppModule.GetName_IROUKAI_KAIJO_TEHAI_No(Me.IROUKAI_KAIJO_TEHAI.Text)
        Me.IROUKAI_SANKA_YOTEI_CNT.Text = AppModule.GetName_IROUKAI_SANKA_YOTEI_CNT(Me.IROUKAI_SANKA_YOTEI_CNT.Text) & "名"
        Me.KOUSHI_ROOM_TEHAI_Yes.Text = AppModule.GetName_KOUSHI_ROOM_TEHAI_Yes(Me.KOUSHI_ROOM_TEHAI.Text)
        Me.KOUSHI_ROOM_TEHAI_No.Text = AppModule.GetName_KOUSHI_ROOM_TEHAI_No(Me.KOUSHI_ROOM_TEHAI.Text)
        ...
        Me.SHAIN_ROOM_TEHAI_Yes.Text = AppModule.GetName_SHAIN_ROOM_TEHAI_Yes(Me.SHAIN_ROOM_TEHAI.Text)
        Me.SHAIN_ROOM_TEHAI_No.Text = AppModule.GetName_SHAIN_ROOM_TEHAI_No(Me.SHAIN_ROOM_TEHAI.Text)
        Me.SHAIN_ROOM_CNT.Text = AppModule.GetName_SHAIN_ROOM_CNT(Me.SHAIN_ROOM_CNT.Text) & "名"
        Me.MANAGER_KAIJO_TEHAI_Yes.Text = AppModule.GetName_MANAGER_KAIJO_TEHAI_Yes(Me.MANAGER_KAIJO_TEHAI.Text)
        Me.MANAGER_KAIJO_TEHAI_No.Text = AppModule.GetName_MANAGER_KAIJO_TEHAI_No(Me.MANAGER_KAIJO_TEHAI.Text)
    ...
    Private Sub SetChangedColor(ByRef control As TextBox, ByVal Data1 As String, ByVal Data2 As String)
        With control
            If CmnModule.IsChanged(Data1, Data2) Then
                .BackColor = Drawing.Color.FromArgb(224, 224, 224)
            Else
